...
<div id="closure-blocks"><?php print $closure_region; ?></div> <?php endif; ?> <?php print $closure; ?> </div></div> <!-- /#page-inner, /#page --> <!-- End Body --> <!-- Start Footer --> </td>
<td id="pcen_right"></td> </tr> </table> <br/> <br/>
<div id="copyright"> &#169; 2010 Primary Care Education</div> <br/> <br/> <!-- End ImageReady Slices -->
<map name="Map">
