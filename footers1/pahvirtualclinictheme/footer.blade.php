        ...
        <section class="fusion-columns row fusion-columns-3 columns columns-3">
            <article class="fusion-column col col-lg-4 col-md-4 col-sm-4 ">
                <div id="text-14" class="footer-widget-col widget_text">
                    <div class="textwidget"><br> <br> <br> <img
            ...
            <article class="fusion-column col col-lg-4 col-md-4 col-sm-4">
                <div id="text-15" class="footer-widget-col widget_text">
                    <div class="textwidget"> Brought to you by: <br> <br> <br> <img
                                src="http://pahvirtualclinic.com/wp-content/uploads/2014/07/UT-Logo.png"/> <br> <br>
                        <br> <br></div>
                    <div style="clear: both;"></div>
                </div>
            </article>
            <article class="fusion-column col col-lg-4 col-md-4 col-sm-4">
                <div id="text-16" class="footer-widget-col widget_text">
                    <div class="textwidget"><br> <br> <img
...
<footer id="pahfooter">
    <div class="avada-row">
        <div class="copyright-area-content">
            <div class="copyright">
                <div>
                    <center>&copy;2015 United Therapeutics Europe Limited. All rights reserved.</center>
                    <br>
                    <center>Remodulin is a registered trademark of United Therapeutics Corporation. (EU/REM/APR15/444)
