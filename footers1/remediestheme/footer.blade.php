    ...
    <div id="footer-inner">
        <div id="footer-message">
            <center> <?php print $footer_message; ?><img src="<?php print $img_path ?>/img/footerlogo.png" alt=""
                                                         class="center"/> <br/> <br/>
                <small> Copyright &copy; <?=date("Y");?> Applied Clinical education unless otherwise noted. CMEZone.com
                    is part of McMahon Group.</br/> All rights reserved.<br/> Reproduction in whole or in part without
