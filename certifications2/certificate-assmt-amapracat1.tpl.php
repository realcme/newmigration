...
<table width="620px">
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:10px;">and is awarded <?php print $earned?>.</td>
          </tr>    
          <tr>
            <td align="center" colspan="2" style="padding-top:20px;padding-bottom:20px;font-size:10pt">
            The Atlanta School of Sleep Medicine &amp; Technology is accredited by the Accreditation Council for Continuing Medical Education to provide continuing medical education for physicians. <br/>
            <br/>
