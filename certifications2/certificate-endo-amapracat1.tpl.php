...
<table width="600px" style="border: 7px solid grey;">
          <tr>
            <td align="center" colspan="2" style="padding-top:5px"><img src="<?php print $img_url?>endo_logo.png"></img></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:10px;font-style:italic">on <?php print $date_earned ?> and is awarded <?php print $certificate['creditearned'].$pratext?>.</td>
          </tr>    
          <tr>
