...
<table width="600px">
          ...
          <tr>
            <td align="left" style="width:50%;padding-top:20px;padding-right:30px;padding-bottom:0px;margin-bottom:0px;">
              <span style='font-size:12.0pt;padding-bottom:0px;font-weight:bold;'>University of Cincinnati <br /> College of Medicine</span>
              <br />
              Material Approval Date:	<?php print $ucc_release_date?><br />
              Material Expiration Date: <?php print $ucc_expiration_date?>	
            </td>
            <td align="right" valign="bottom" style="width:50%;padding-left:20px;padding-bottom:0px;margin-bottom:0px">
              <img src="<?php print $img_url?>ucc_signature.png"></img><br />
              <div style="position:relative;bottom:40px">
              <span style='font-size:12.0pt;padding-bottom:0px;font-weight:bold;'>John R. Kues, Ph.D.</span><br />
              <span style='font-size:12.0pt;padding-top:0px;font-weight:bold'>Assistant Dean, CME</span> <br />
              <span style='font-size:12.0pt;padding-top:0px;font-weight:bold'>Continuous Professional</span>
              <span style='font-size:12.0pt;padding-top:0px;font-weight:bold'>Development</span>
              </div>
            </td>
          </tr>
          <tr>
