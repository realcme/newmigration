    ...
    <table style="border: 3px solid black; width:600px">
      <tr><td>
        <table style="border: 1px solid black;">
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:25px"><span style="font-weight:bold;">Cedars-Sinai Medical Center certifies that <?php print $certificate['fullname']?> has participated in the educational activity titled</span></td>
          </tr>          
          <tr>
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:10px"><span style="font-weight:bold;">on <?php print $certificate['dateearned'] ?> and is awarded <?php print $certificate['amapracat1'].$pratext ?>.</span></td>
          </tr>          
          <tr>
