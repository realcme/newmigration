...
<table width="620px" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="2" align="center" style="padding-top: 15px">This certifies that this participant has spent <?php print $certificate['amapracat1'] ?> hour(s) in this educational activity.</td>
    </tr>
    <tr>
