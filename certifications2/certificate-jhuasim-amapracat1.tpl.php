...
<div style="font-size:12.0pt;font-family:Arial, Times, serif;color: #000000;clear: both;margin: auto;width: 600px;padding: 0px;">
    <table style="width: 100%;">
            <tr>
              ...
              <td align="center" style="vertical-align: top;"><span style='font-size:16.0pt;font-weight:bold;'>CERTIFICATE OF PARTICIPATION</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="left" colspan="2" style="padding-top:10px">
                ...
                Date Credit Issued: <?php print $certificate['dateearned'] ?>
              </td>
            </tr>
            <tr>
              <td align="left" colspan="2" style="padding-top:10px;font-size:10.0pt;">
                <ul>
                  ...
                  <li>Participants should claim only those hours of credit that he/she actually spends in the educational activity.</li>
                </ul>
              </td>
            </tr>
            <tr>
              <td align="left" colspan="2" style="padding-top:5px;padding-bottom:0px;font-size:10.0pt;">
