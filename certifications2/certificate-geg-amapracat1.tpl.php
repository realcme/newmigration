  ...
  <tr>
    <td>
      <table  style="border: 3px solid #CCCCCC; width: 100%" >
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:15px;padding-bottom:25px"><span style='font-size:24.0pt;font-weight: bold'>Certificate of Credit</span></td>
          </tr>                    
          <tr>
          ...
          <tr>
            <td align="center" colspan="2" style="padding: 5px 10px">on  <?php print $certificate['dateearned'] ?> and is awarded <?php print $c ?>.   
            </td>
          </tr>
          <tr>
