    ...
    <table style="border: 5px solid #000000; width:100%">
      <tr><td>
        <table style="border: none;width: 100%">          
          ...
          <tr>
            <td align="center" colspan="2" style="border-top:1px solid #000000;border-bottom:1px solid #000000;padding-top: 15px;padding-bottom: 15px;font-weight:bold">Certificate of Participation</td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:15px">on <?php print $certificate['dateearned'] ?>. This activity was designated for</td>
          </tr>         
          <tr>
            <td align="center" colspan="2" style="padding-top:5px"><?php print $certificate['amapracat1'].$pratext ?></td>
          </tr>
          <tr>
