...
<head><title>BLHC | BLHC - Pediatrics</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/pediatricstheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/86074d5363c2a04b0221b80b3dd79713.css";</style>
    <!--[if IE]>
    ...
    <div class="container">
        <div id="top-row" class="row">
            <div id="home-logo-container" class="span4"><a href="/cms/"><img
                            src="/cms/sites/all/themes/zen/pediatricstheme/img/QIGateway_RGB.png" id="logo"
                            alt="CIR-PEI"></a></div>
            <div id="home-right-logo-container" class="span8"><img
                        src="/cms/sites/all/themes/zen/pediatricstheme/img/Bronx+Lebanon+Logo.JPG"></div>
            <div class="span8">
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/pediatricstheme/img/logo-companion.gif"
