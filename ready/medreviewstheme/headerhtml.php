...
<head><title>MedReviews | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/medreviewstheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/eff993a1e4383a97030654ac387d9704.css";</style>
    <!--[if IE]>
    ...
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo"><a href="http://medreviews.com/" title="Home" rel="home"><img
                                src="/cms/sites/all/themes/zen/medreviewstheme/img/new_images/logo.png" alt="Home"
                                id="logo-image"/></a></div>
            </div>
        ...
        <div id="page-main" style="border-top: 53px #21376e solid;">
            <div id="main-inner" class="clear-block with-navbar">
                        ...
                        <div id="content-area">
                            <div class='view view-listing-all'>
                                <div class='listing-tabs'>
                                    <form action="http://medreviews.realcme.net/cms/listingall" accept-charset="UTF-8"
                ...
                <div id="sidebar-right" style="min-width: 0;">
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/medreviewstheme/img/logo-companion.gif"
        ...
        <div style="background-color: #2d2d2d; border-top: 40px #313131 solid; padding:3em 20em; margin:0 -24em;">
            <div style="margin: auto; color: #8F8F8F;"> Copyright © 2017 MedReviews, LLC. All rights reserved</div>
        </div>
    </div> <!-- Close Footer -->
