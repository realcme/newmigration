...
<head><title>NovaMed</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/novamedtheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/f9baafa182b2c785ed2b7057126984fe.css";</style>
    <!--[if IE]>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo"><a href="/cms/" title="Home" rel="home"><img
                                src="/cms/sites/all/themes/zen/novamedtheme/img/new_images/logo.png" alt="Home"
                                id="logo-image"/></a></div>
            </div>
                        ...
                        <div id="content-area">
                            <div class='view view-listing-all'>
                                ...
                                <div class='listing-tabs'>
                                    <form action="http://novamed.realcme.com/cms/listingall" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-listing-all'>
                                    <table>
                                        ...
                                        <tbody>
                                        <tr class="odd">
                                            <td colspan="13" align="left" valign="top" class="listingtopic">Infectious
                                                Diseases
                                            </td>
                                        </tr>
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                align="center" valign="top"><img
                                                        src="http://novamed.realcme.com/cms/../cmsdata/course_icons/icon_603696_0.png"
                                                        alt="icon_603696.png" title="icon_603696.png" width="43"
                                                        height="43" class="imagefield imagefield-field_icon"/></td>
                                            <td class="view-field view-field-node-title"><a
                                                        href="/cms/node/807304?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=all&amp;utm_campaign=">Let`s
                                                    Get Real About PrEP</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">24-Aug-17</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single">23-Aug-18</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-activity-group-field-activity-group-nid">
                                                <a href="/cms/node/807307">Let&#039;s Get Real About&amp;nbsp;PrEP</a>
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                align="center" valign="top"><img
                                                        src="http://novamed.realcme.com/cms/../cmsdata/course_icons/icon_606098.png"
                                                        alt="icon_606098.png" title="icon_606098.png" width="43"
                                                        height="43" class="imagefield imagefield-field_icon"/></td>
                                            <td class="view-field view-field-node-title"><a
                                                        href="/cms/node/815097?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=all&amp;utm_campaign=">Let&#039;s
                                                    Get Real About PrEP: For Community Outreach Workers</a></td>
                                            <td class="view-field view-field-term-node-1-name">Infectious Diseases</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Richard A. Elion, MD
                                            </td>
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">26-Sep-17</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value"></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single">26-Sep-18</span></td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                606098
                                            </td>
                                            <td class="view-field view-field-node-data-field-patient-statement-field-patient-statement-value"></td>
                                            ...
                                            <td class="view-field view-field-term-node-3-name"></td>
                                            <td class="view-field view-field-node-data-field-activity-group-field-activity-group-nid">
                                                <a href="/cms/node/815100">riq_607814</a></td>
                                            <td class="view-field view-field-content-type-activity-group-field-group-name-value">
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/novamedtheme/img/logo-companion.gif"
