...
<head><title>Accelmed (Chronic Pain) | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/cp-accelmedtheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/669558119e47cf203947119bf76e4e49.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/cp-accelmedtheme/img/cp-logo.jpg" alt="Home"
                                    id="logo-image"/></a></div>
                </div> <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://cp-accelmed.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://cp-accelmed.realcme.net/cms/../cmsdata/course_icons/webicon-042712-CME12009_0.jpg"
                                                        alt="webicon-042712-CME12009.jpg"
                                                        title="webicon-042712-CME12009.jpg" width="42" height="42"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/242813">Case
                                                    Discussion: The Role of Neuromodulatory Analgesics in Chronic Pain
                                                    Management</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">15-May-12</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">15-May-13</span></span>
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://cp-accelmed.realcme.net/cms/../cmsdata/course_icons/webicon-042712-CME12009.jpg"
                                                        alt="webicon-042712-CME12009.jpg"
                                                        title="webicon-042712-CME12009.jpg" width="42" height="42"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/242805">Current
                                                    Understanding of Chronic Pain Pathophysiology and its Implication in
                                                    Treatment Selection</a></td>
                                            <td class="view-field view-field-term-node-1-name">Pain Management</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Daniel J. Clauw, MD
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/cp-accelmedtheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/cp-accelmedtheme/img/footerlogo.png" alt=""
                                        class="center"/> <br/> <br/>
                        <p>
                            <small><img src="/cms/sites/all/themes/zen/cp-accelmedtheme/img/cp-footer.jpg" alt=""
                                        class="center"/></small>
                        </p>
                    </center>
                </div>
