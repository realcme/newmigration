...
<head><title>Accelmed (Chronic Pain)</title>
    ...
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/b46e536a020b876ab7d1f236bdf9aabd.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://cp-accelmed.realcme.com/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://cp-accelmed.realcme.com/cms/../cmsdata/course_icons/webicon-042712-CME12009_0.jpg"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://cp-accelmed.realcme.com/cms/../cmsdata/course_icons/webicon-042712-CME12009.jpg"
                                                        alt="webicon-042712-CME12009.jpg"
                                                        title="webicon-042712-CME12009.jpg" width="42" height="42"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
