...
<head><title>Medscape | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/medscapetheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/8cc8dc4630ffbae767a26f4cc5d915e9.css";</style>
    <!--[if IE]>
    ...
    <div id="page-inner">
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="http://cme.medscape.com" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/medscapetheme/img/logo.gif" alt="Home"
                                    id="logo-image"/></a></div>
                    <a href="http://cme.medscape.com/viewcollection/30715" id="logo-medscape-link">&lt;&lt; Back to
                        MedscapeCME</a></div><!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://medscape.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://medscape.realcme.net/cms/../cmsdata/course_icons/82_Male_20-30_W_OV_0.gif"
                                                        alt="82_Male_20-30_W_OV.gif" title="82_Male_20-30_W_OV.gif"
                                                        width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/>Troy
                                            </td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/14906">Troy
                                                    Visit 1: A 47-Year-Old Male With Chronic HCV Thinking About
                                                    Treatment</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                1&nbsp;AMA<br/>0.9&nbsp;ANCC<br/>1&nbsp;AAPA<br/></td>
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-title"><a href="/cms/node/15056">Troy
                                                    Visit 2: A 47-Year-Old Male With Chronic HCV Returning For
                                                    Follow-up</a></td>
                                            <td class="view-field view-field-term-node-1-name">Infectious Diseases</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Anne M. Croghan, MN, ARNP
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">22-Mar-10</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                1&nbsp;AMA<br/>0.8&nbsp;ANCC<br/>1&nbsp;AAPA<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">21-Mar-11</span></span>
                                            </td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                troy
                                            </td>
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/medscapetheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
