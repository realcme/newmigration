...
<head><title>Scale HIV</title>
    ...
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/90114d8d527dca342c54165ceb323d8e.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://scale-hiv.realcme.com/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://scale-hiv.realcme.com/cms/../cmsdata/course_icons/icon_conrad.gif"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://scale-hiv.realcme.com/cms/../cmsdata/course_icons/icon_gloria.gif"
