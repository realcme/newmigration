...
<head><title>PSAStudy | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/psastudytheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/94c437d72b96f61945d6d123344c45c3.css";</style>
    <!--[if IE]>
    ...
    <div id="page-inner">
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><img src="/cms/sites/all/themes/zen/psastudytheme/img/logo_home.gif" alt="Home"
                                        id="logo-image" usemap="#header_img"/></div>
                    <map name="header_img">
                        <area shape="circle" coords="47,53,40" href="http://www.aecom.yu.edu/home/" target="_blank"/>
                        <area shape="rect" coords="860,17,945,82" href="http://www.montefiore.org/" target="_blank"/>
                    </map>
                </div> <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://psastudy.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="3" align="center" valign="top"><img
                                                        src="http://psastudy.realcme.net/cms/../cmsdata/course_icons/sue.gif"
                                                        alt="sue.gif" title="sue.gif" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/>Psoriatic
                                                Arthritis - Study
                                            </td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/13704">PSA
                                                    Study - Sue Visit 1: A 34-Year-Old Woman With Longstanding Psoriasis
                                                    and Onset of Stiffness and Foot Pain</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">24-Nov-09</span></td>
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-title"><a href="/cms/node/13709">PSA
                                                    Study - Sue Visit 2: A 34-Year-Old Woman With Newly Diagnosed
                                                    Psoriatic Arthritis</a></td>
                                            <td class="view-field view-field-term-node-1-name">Rheumatology</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                M. Elaine Husni, MD, MPH
                                            </td>
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">01-Dec-09</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value"></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">03-Dec-10</span></span>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-title"><a href="/cms/node/13712">PSA
                                                    Study - Sue Visit 3: A 34-Year-Old Woman With Newly Diagnosed
                                                    Psoriatic Arthritis Starting Therapy </a></td>
                                            <td class="view-field view-field-term-node-1-name">Dermatology</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Abrar Qureshi, MD, MPH
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/psastudytheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/psastudytheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
