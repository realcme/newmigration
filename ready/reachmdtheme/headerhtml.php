...
<head><title>ReachMD | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/reachmdtheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/063da01b90676945d1fa67fcd4b15695.css";</style>
    <!--[if IE]>
    ...
    <div id="page-inner">
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><img src="/cms/sites/all/themes/zen/reachmdtheme/img/reachmd_header.gif" alt="Home"
                                        id="logo-image" usemap="#header_img"/></div>
                    <map name="header_img">
                        <area shape="rect" coords="125,15,390,90" href="http://www.reachmd.com/cme.aspx" alt="ReachMD"/>
                    </map>
                </div> <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://reachmd.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://reachmd.realcme.net/cms/../cmsdata/course_icons/icon-howard.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://reachmd.realcme.net/cms/../cmsdata/course_icons/joseph.gif"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/reachmdtheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/reachmdtheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
                <img src="/cms/sites/all/themes/zen/reachmdtheme/img/reachmd_footer.gif" alt="" usemap="#footer_img"/>
                <map name="footer_img">
