...
<head><title>PDP Series|-|</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/pdpseriestheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/e35c44f5793cd560f21f19100d84a5b3.css";</style>
    <!--[if IE]>
    ...
    <script type="text/javascript" src="/cms/sites/all/themes/zen/pdpseriestheme/js/mycme.js"></script>
...
<div class="stickyNav" id="mainNavContainer">
    <div id="mainNavWrapper">
        <div id="mainNavLogoWrapper">
            <div id="logoWrapper" class="grid_2"><a href="http://pdpseries.com/"> <img style="max-height: 78px;"
                                                                                       src="/cms/sites/all/themes/zen/pdpseriestheme/img/pdp_logo.png"
                                                                                       alt="pdpseries.com"
                                                                                       class="pngfix"></img></a></div>
            <nav id="mainNav" style="display:none;">
                <ul class="grid_9 regNav">
                    <li class="firstNavItem"><a href="http://pdpseries.com/#webinar" class="topNavItem">On Demand
                            Webinar</a></li>
                    <li><a href="http://pdpseries.com/#earn" class="topNavItem">CME MONOGRAPH</a></li>
                    <li><a href="http://pdpseries.com/#library" class="topNavItem">CME VIDEO CASE LIBRARY</a></li>
                </ul>
    ...
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <!-- <div id="logo-title"> <div id="logo"><a href="/cms/../" title="Home" rel="home"><img src="/cms/sites/all/themes/zen/pdpseriestheme/img/logo.gif" alt="Home" id="logo-image" /></a></div> </div> -->
                <!-- /#logo-title --> </div>
                        ...
                        <div id="content-area">
                                            ...
                                            <div class="node-inner">
                                                <div class="rcmcontent">
                                                    <div class="related-patient-bg"
                                                        ...
                                                        <img src="/cms/../cmsdata/course_icons/icon_592788.jpg"
                                                             alt="592788"
                                                    ...
                                                    <div class="activity-subject">
                                                        <div class="activity-title activity-title-display"><span
                                                                    class="promo-link"><a id="lt-824651"
                                                                                          href="/cms/node/824651">Finding Balance: New Strategies to Optimize Care for Patients With...</a></span>
                                                        </div>
                                                    ...
                                                    <div class="activity-info">Finding Balance: New Strategies to
                                                        Optimize Care for Patients With Parkinson's Disease Psychosis
                                                    </div>
                                                    ...
                                                    <div class="next-steps-related">
                                                        ...
                                                        <div class="proceed-activity"><span class="promo-link"><a
                                                                        id="lp-824651" href="/cms/node/824651">Proceed To Activity</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class='listing-featured'>
                                <div class='listing-tabs'>
                                    <form action="http://pdpseries.realcme.com/cms/listingall" accept-charset="UTF-8"
                                        ...
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://pdpseries.realcme.com/cms/../cmsdata/course_icons/icon_592788.jpg"
                                                        alt="icon_592788.jpg" title="icon_592788.jpg" width="43"
                                                        height="43"/></td>
                                            <td valign="top" style="font-weight: normal;" class="view-field-node-title">
                                                <a href="/cms/node/824651?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=feature&amp;utm_campaign=">Finding
                                                    Balance: New Strategies to Optimize Care for Patients With Parkinson&#039;s
                                                    Disease Psychosis</a><br/>Neurology
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/pdpseriestheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/pdpseriestheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
...
<footer id="globalFooter">
    <div class="rawHTMLAsset"><p style="text-align: center;">© 2018 MedEdicus LLC 124</p></div>
    </div> </footer> <!-- END FOOTER --> </body>
</html>
