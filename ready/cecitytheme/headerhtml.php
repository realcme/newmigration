...
<head><title>CECity | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/cecitytheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/9f3d5c372470fcbc0cd8c48341fbbac8.css";</style>
    <!--[if IE]>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                src="/cms/sites/all/themes/zen/cecitytheme/img/new_images/logo.png" alt="Home"
                                id="logo-image"/></a></div>
            </div>
            ...
            <div id="main-inner" class="clear-block with-navbar">
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://cecity.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://cecity.realcme.net/cms/../cmsdata/course_icons/howard.gif"
                                                        alt="howard.gif" title="howard.gif" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/>Howard
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://cecity.realcme.net/cms/../cmsdata/course_icons/icon_isitalzheimerdisease_0.jpg"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://cecity.realcme.net/cms/../cmsdata/course_icons/joseph.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://cecity.realcme.net/cms/../cmsdata/course_icons/icon-margy.gif"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://cecity.realcme.net/cms/../cmsdata/course_icons/icon-raj.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://cecity.realcme.net/cms/../cmsdata/course_icons/icon_timothy.gif"
                                            ...
                                            <td class="view-field view-field-node-title"><a href="/cms/node/67362">Timothy
                                                    Visit 1: A 45-Year-Old Man Presenting With Widespread Chronic
                                                    Pain</a></td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-title"><a href="/cms/node/69737">Timothy
                                                    Visit 2: A 45-Year-Old Man With Widespread Chronic Pain, Returning
                                                    for Follow-Up</a></td>
                                            <td class="view-field view-field-term-node-1-name">Fibromyalgia</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Michael R. Clark, MD, MPH
                ...
                <div id="sidebar-right">
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2"> <!-- Accordion Menu Start -->
                            <div id="list1"></div>
