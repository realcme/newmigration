...
<head><title>Do It Better</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/doitbettertheme/print.css" type="text/css" media="print"/>
    <!--[if IE]>
    ...
    <link rel="stylesheet" media="all" href="/cms/sites/all/themes/zen/doitbettertheme/css/doitbetter.css"/>
    <style> body {
...
<header>
    <div class="container">
        <div class="row">
            <div class="col-6 col-md-9"><a href=""> <img class="img-fluid" id="logo"
                                                         src="/cms/sites/all/themes/zen/doitbettertheme/img/do-it-better-logo_692x69.png"
                                                         alt="Do It Better logo" style="width:300px;"> </a>
...
<style type="text/css" media="all">@import "/cms/../cmsdata/css/e3155f4575d7580c458bd8c0456766bd.css";</style>
    ...
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <!-- <div id="logo-title"> <div id="logo"><a href="/cms/../" title="Home" rel="home"><img src="/cms/sites/all/themes/zen/doitbettertheme/img/logo.gif" alt="Home" id="logo-image" /></a></div> </div> -->
                <!-- /#logo-title --> </div>
                        ...
                        <div id="content-area">
                            <div class='view view-listing-all'>
                                ...
                                <div class='listing-tabs'>
                                    <form action="http://doitbetter.realcme.com/cms/listingall" accept-charset="UTF-8"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                align="center" valign="top"><img
                                                        src="http://doitbetter.realcme.com/cms/../cmsdata/course_icons/icon_613363.jpg"
                                            ...
                                            <td class="view-field view-field-node-title"><a
                                                        href="/cms/node/851024?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=all&amp;utm_campaign=">The
                                            ...
                                            <td class="view-field view-field-node-data-field-course-desc-field-course-desc-value">
                                                This activity uses interactive case scenarios to examine the role of the
                                                pharmacist in the management of T2D.
                                            </td>
                                            ...
                                            <td class="view-field view-field-node-data-field-activity-group-field-activity-group-nid">
                                                <a href="/cms/node/851027">riq_622571</a></td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/doitbettertheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/doitbettertheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
