    ...
    try {
        ...
        if (urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp') {//code to show images
            ...
            imgPreloader.onload = function () {
                ...
                if (!(TB_PrevHTML === "")) {
                    function goPrev() {
                        if (rcme(document).unbind("click", goPrev)) {
                            rcme(document).unbind("click", goPrev);
                        }
...
function tb_remove() {
    ...
    if (rcme("#list1").find(".cmeloginregistration").length > 0) {
        ...
        rcme("#TB_window").fadeOut("fast", function () {
            rcme('#TB_window,#TB_overlay,#TB_HideSelect').trigger("unload").unbind().remove();
        });
        rcme("#TB_load").remove();
        if (typeof document.body.style.maxHeight == "undefined") {//if IE 6
...
function navclick(el) {
    ...
    if (rcmewait.length) {
        ...
        rcmeajax.load('/cms/getblock' + el.id, function () {		// el.id is 'planner' or 'tracker'
            ...
            rcmewait.animate({opacity: 0, height: 0}, function () {
                rcmewait.remove()
            });
...
rcme(document).ready(function () {
    rcme("#biobutton1").click(function () {
        rcme("#biotext1").toggle();
    });
    rcme("#biobutton2").click(function () {
        rcme("#biotext2").toggle();
    });
    rcme("#biobutton3").click(function () {
        rcme("#biotext3").toggle();
    });
    rcme("#biobutton4").click(function () {
        rcme("#biotext4").toggle();
    });
    rcme("#biobutton5").click(function () {
        rcme("#biotext5").toggle();
    });
    rcme("#biobutton6").click(function () {
        rcme("#biotext6").toggle();
    });
    rcme("#biobutton7").click(function () {
        rcme("#biotext7").toggle();
    });
    rcme("#biobutton8").click(function () {
        rcme("#biotext8").toggle();
    });
    rcme("#biobutton9").click(function () {
        rcme("#biotext9").toggle();
    });
    rcme("#biobutton10").click(function () {
        rcme("#biotext10").toggle();
    });
});
 ...
 */
(function (rcme) {
    rcme.fn.bgIframe = rcme.fn.bgiframe = function (s) {
        if (rcme.browser.msie && rcme.browser.version < 7) {
            s = rcme.extend({
                top: 'auto',
                left: 'auto',
                width: 'auto',
            ...
            return this.each(function () {
                if (rcme('> iframe.bgiframe', this).length == 0) this.insertBefore(document.createElement(html), this.firstChild);
            });
        }
        return this;
    };
