...
<head><title>CME Outfitters</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/cmeoutfitterstheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/6d25837ecc47a3e60d622927dff8dcd1.css";</style>
    <!--[if IE]>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        <td colspan="3">
                            <table cellspacing="0" cellpadding="0" border="0" align="left">
                                <tbody>
                                <tr>
                                    <td><a title="CME Outfitters: Continuing Medical Education With Integrity"
                                           href="http://www.cmeoutfitters.com/list.asp"><img width="180" height="72"
                                                                                             border="0"
                                                                                             align="absmiddle"
                                                                                             alt="CME Outfitters: Continuing Medical Education With Integrity"
                                                                                             src="/cms/sites/all/themes/zen/cmeoutfitterstheme/img/logo.gif"></a>
                                    </td>
                                    <td><h3 style="color: rgb(102, 102, 102); margin-bottom: 0pt;"><a
                                                    href="http://www.cmeoutfitters.com/integrity.asp">Education<br>With
                                                Integrity</a></h3></td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        <td width="180"><img width="180" height="1"
                                             src="/cms/sites/all/themes/zen/cmeoutfitterstheme/img/spacer.gif"></td>
                        <td width="99%" bgcolor="#818569"><img width="391" height="9"
                                                               src="/cms/sites/all/themes/zen/cmeoutfitterstheme/img/top.gif">
                        </td>
                        <td width="13"><img width="13" height="9"
                                            src="/cms/sites/all/themes/zen/cmeoutfitterstheme/img/top_corner.gif"></td>
                    </tr>
                    <tr bgcolor="#818569">
                        <td>&nbsp;</td>
                        <td align="right"></td>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://cmeoutfitters.realcme.com/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://cmeoutfitters.realcme.com/cms/../cmsdata/course_icons/120_Female_30-40_W_NW.gif"
                                                        alt="120_Female_30-40_W_NW.gif"
                                                        title="120_Female_30-40_W_NW.gif" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/>Joyce
                                            </td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/14526">Joyce
                                                    Visit 1: Case Series in Rheumatoid Arthritis, Part 3: Identification
                                                    of Early Rheumatoid Arthritis</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">28-Apr-10</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">27-Apr-11</span></span>
                                            </td>
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-title"><a href="/cms/node/14535">Joyce
                                                    Visit 2: Case Series in Rheumatoid Arthritis, Part 4: 3-Month
                                                    Follow-Up After Start on Biologic</a></td>
                                            <td class="view-field view-field-term-node-1-name">Rheumatology</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                John J. Cush, MD
                                            </td>
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://cmeoutfitters.realcme.com/cms/../cmsdata/course_icons/136_Female_40-50_W_OW.gif"
                                                        alt="136_Female_40-50_W_OW.gif"
                                                        title="136_Female_40-50_W_OW.gif" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/>Linda
                                            </td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/14516">Linda
                                                    Visit 1: Case Series in Rheumatoid Arthritis, Part 1: Partial
                                                    Response to a Biologic</a></td>
                                            <td class="view-field view-field-term-node-1-name">Rheumatology</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                John J. Cush, MD
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-title"><a href="/cms/node/14521">Linda
                                                    Visit 2: Case Series in Rheumatoid Arthritis, Part 2: 3-Month
                                                    Follow-Up After Switch to Another Biologic</a></td>
                                            <td class="view-field view-field-term-node-1-name">Rheumatology</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                John J. Cush, MD
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/cmeoutfitterstheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/cmeoutfitterstheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
