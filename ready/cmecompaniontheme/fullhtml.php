...
<head><title>CMECompanion</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/aace-medtelligencetheme/cmecompaniontheme/print.css"
          type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/3d2ef25333b24d6bb0de1d57a3037ac4.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/aace-medtelligencetheme/cmecompaniontheme/img/cmecompanion-logo-99x56.png"
                                    alt="Home" id="logo-image"/></a></div>
                    <div style="font-size: 18pt; font-family: 'Montserrat', sans-serif; padding-left:10px; vertical-align: bottom; display: table-cell; margin-top: 10px; float: left; height: 56px; border-left: 1px solid #cccccc;">
                        Making CME Matter<span style="font-size: 12pt">&reg;</span></div>
                </div>
            </div>
                        ...
                        <div id="content-area">
                                                ...
                                                <div class="rcmcontent">
                                                    ...
                                                    <div class="activity-subject">
                                                        <div class="activity-title activity-title-display"><span
                                                                    class="promo-link"><a id="lt-155827"
                                                    ...
                                                    <div class="activity-info">"I&#39;m feeling a bit better, but my
                                                        hands and feet are still sore and I&#39;m tired all the time." "
                                                    </div>
                                                    ...
                                                    <div class="next-steps-related">
                                                        ...
                                                        <div class="proceed-activity"><span class="promo-link"><a
                                                                        id="lp-155827" href="/cms/node/155827">Proceed To Activity</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="node">
                                            <div class="node-inner">
                                                <div class="rcmcontent">
                                                    <div class="related-patient-bg"
                                                         style="background-image: url(/cms/sites/all/modules/custom/cmecoursepromotion/img/related-patient-bg.gif); ">
                                                        <img src="/cms/../cmsdata/course_icons/LayoutCover_1c.png"
                                                             alt="copd-pc"
                                                             style="width: 43px; height: 43px; border: 0; margin: 0">
                                                    </div>
                                                    <div class="activity-subject">
                                                        <div class="activity-title activity-title-display"><span
                                                                    class="promo-link"><a id="lt-200758"
                                                                                          href="/cms/node/200758">An Evidence-based Approach to the Diagnosis and Treatment of COPD:...</a></span>
                                                        </div>
                                                        <div class="certified-icon"
                                                             style="background-image: url(/cms/sites/all/modules/custom/cmecoursepromotion/img/CME-certified.gif); "></div>
                                                        <div class="certified-text">Pulmonary Disease</div>
                                                    </div>
                                                    <div class="activity-info">An Evidence-based Approach to the
                                                    ...
                                                    <div class="next-steps-related">
                                                        ...
                                                        <div class="proceed-activity"><span class="promo-link"><a
                                                                        id="lp-200758" href="/cms/node/200758">Proceed To Activity</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class='listing-featured'>
                                <div class='listing-tabs'>
                                    <form action="http://cmecompanion.realcme.com/cms/listingall" accept-charset="UTF-8"
                                ...
                                <div class='listing-featured-table'>
                                    <table id="listing-featured" align="center">
                                        ...
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://cmecompanion.realcme.com/cms/../cmsdata/course_icons/icon_2.jpg"
                                        ...
                                        <tr class="even">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://cmecompanion.realcme.com/cms/../cmsdata/course_icons/icon_hillary_0.gif"
                                        ...
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://cmecompanion.realcme.com/cms/../cmsdata/course_icons/duke_logo_0.jpg"
                                        ...
                                        <tr class="even">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://cmecompanion.realcme.com/cms/../cmsdata/course_icons/icon_kelley.gif"
                                        ...
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://cmecompanion.realcme.com/cms/../cmsdata/course_icons/LayoutCover_1c.png"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/aace-medtelligencetheme/cmecompaniontheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img
                                src="/cms/sites/all/themes/zen/aace-medtelligencetheme/cmecompaniontheme/img/footerlogo.png"
