...
<head><title>Institute for Continuing Healthcare Education | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/ichetheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/52922edd5d0718cf1094b86378814e1c.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/ichetheme/img/logo.png" alt="Home" id="logo-image"
                                    width="175"/></a></div>
                </div> <!-- /#logo-title -->
                <table cellspacing="0" cellpadding="0" border="0" class="right">
                    <tr>
                        <td><img width="7" height="40" src="/cms/sites/all/themes/zen/ichetheme/img/space.gif" alt="">
                        </td>
                        <td bgcolor="#f1f2f4"><img width="130" height="40"
                                                   src="/cms/sites/all/themes/zen/ichetheme/img/space.gif" alt=""></td>
                        <td><img width="7" height="40" src="/cms/sites/all/themes/zen/ichetheme/img/space.gif" alt="">
                        </td>
                        ...
                        <td bgcolor="#969da5" align="right"><img width="135" height="40"
                                                                 src="/cms/sites/all/themes/zen/ichetheme/img/space.gif"
                                                                 alt=""></td>
                    </tr>
                </table>
                <!-- <div style="clear: both" id="header_bar"><img width="330" src="/cms/sites/all/themes/zen/ichetheme/img/topbanner.jpg" alt=""></div> -->
            </div>
                        ...
                        <div id="content-area">
                            <div class='view view-listing-all'>
                                <div class='listing-tabs'>
                                    <form action="http://iche.realcme.net/cms/listingall" accept-charset="UTF-8"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/ichetheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/ichetheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
