<!DOCTYPE html>
<html lang="en">
<head><title>RealCME Health Professional | STAGING</title>
                        ...
                        <div id="content-area">
                                            ...
                                            <div class="node-inner">
                                                <div class="rcmcontent">
                                                    <div class="related-patient-bg"
                                                        ...
                                                        <img src="/cms/../cmsdata/course_icons/Handsrheum_0.png"
                                                             alt="347280"
                                                    ...
                                                    <div class="activity-subject">
                                                        <div class="activity-title activity-title-display"><span
                                                                    class="promo-link"><a id="lt-471443"
                                                                                          href="/cms/node/471443">Rheumatology Nurse Newsletter - Volume 6, Issue 4 (Winter)</a></span>
                                                        </div>
                                                    ...
                                                    <div class="activity-info">Rheumatology Nurse Newsletter - Volume 6,
                                                        Issue 4 (Winter)
                                                    </div>
                                                    ...
                                                    <div class="next-steps-related">
                                                        ...
                                                        <div class="proceed-activity"><span class="promo-link"><a
                                                                        id="lp-471443" href="/cms/node/471443">Proceed To Activity</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class='listing-featured'>
                                <div class='listing-tabs'>
                                    <form action="http://hp.realcme.net/cms/listingall" accept-charset="UTF-8"
                                ...
                                <div class='listing-featured-table'>
                                    <table id="listing-featured" align="center">
                                        ...
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://hp.realcme.net/cms/../cmsdata/course_icons/icon_438512.jpg"
                                                        alt="icon_438512.jpg" title="icon_438512.jpg" width="43"
                                                        height="43"/></td>
                                            <td valign="top" style="font-weight: normal;" class="view-field-node-title">
                                                <a href="/cms/node/475653?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=feature&amp;utm_campaign=">Cases
                                                    in Binge Eating Disorder</a><br/>Psychiatry
                                            </td>
                                            ...
                                            <td class="view-field-node-data-field-faculty-field-faculty-value">Tracy S.
                                                Cummings, MD
                                            </td>
                                        ...
                                        <tr class="even">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://hp.realcme.net/cms/../cmsdata/course_icons/Handsrheum_0.png"
                                                        alt="Handsrheum.png" title="Handsrheum.png" width="43"
                                                        height="43"/></td>
                                            <td valign="top" style="font-weight: normal;" class="view-field-node-title">
                                                <a href="/cms/node/471443?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=feature&amp;utm_campaign=">Rheumatology
                                                    Nurse Newsletter - Volume 6, Issue 4 (Winter)</a><br/>Rheumatology
                                            </td>
                                            <td valign="top" style="font-weight: normal;text-align: center"
                                                class="view-field-node-data-field-all-credits-field-all-credits-value">
                                                1.5&nbsp;ANCC<br/>1.8&nbsp;CA-BRN<br/></td>
                                            <td valign="top" style="color:#aaa; font-style:italic;"
                                                class="view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                23-Dec-16
                                            </td>
                                            ...
                                            <td class="view-field-node-data-field-patient-statement-field-patient-statement-value"></td>
                                            <td class="view-field-node-data-field-course-desc-field-course-desc-value"></td>
                                            <td class="view-field-node-data-field-faculty-field-faculty-value">Kori A.
                                                Dewing, DNP, ARNP
                                            </td>
                                            <td class="view-field-term-node-3-name">Rheumatoid Arthritis</td>
                                            <td class="view-field-node-data-field-activity-group-field-activity-group-nid">
                                                441593
                                            </td>
                                            <td class="view-field-content-type-activity-group-field-group-name-value">
                                                Rheumatology Nurse Newsletter 2013
                                            </td>
                                            <td class="related-activities"></td>
                                        </tr>
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://hp.realcme.net/cms/../cmsdata/course_icons/icon_498656_0.png"
