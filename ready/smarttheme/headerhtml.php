...
<head><title>DKB | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/smarttheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/ad5ca93ea12d4d46edc2703edf6e54de.css";</style>
    <!--[if IE]>
    ...
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo"><a href="http://dkbmed.com/smartrealcme" rel="home"><img
                                src="/cms/sites/all/themes/zen/smarttheme/img/smart_logo.png" alt="Home"
                                id="logo-image"/></a></div>
            </div>
                        ...
                        <div id="content-area">
                            <div class='view view-listing-all'>
                                <div class='listing-tabs'>
                                    <form action="http://smart.realcme.net/cms/listingall" accept-charset="UTF-8"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/smarttheme/img/logo-companion.gif"
        ...
        <div id="footer">
            <div id="footerLogo"><img src="/cms/sites/all/themes/zen/smarttheme/img/smart_footer_logo.png" alt="dkb">
                <img src="/cms/sites/all/themes/zen/smarttheme/img/smart_pim_footer_logo.png" akt="pim"></div>
            <div id="copyright"><a href="http://dkbmed.com/#privacy" target_"blank">privacy</a> | &copy; 2018
                dkbmed<br/></div>
