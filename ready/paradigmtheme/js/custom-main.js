...
function truethemes_Nav() {
    ...
    var t = 260;
    jQuery(e).find(".sub-menu").css({left: 0});
    jQuery(e).find("> li").each(function () {
        ...
        jQuery(this).mouseenter(function () {
            ...
            if (navigator.appName == "Microsoft Internet Explorer") jQuery(n).css({display: "block"}).stop().animate({height: e}, t, function () {
                jQuery(this).css({overflow: "visible"})
            }); else jQuery(n).css({display: "block"}).stop().animate({height: e, opacity: 1}, t, function () {
                jQuery(this).css({overflow: "visible"})
            })
        }).mouseleave(function () {
            var e = jQuery(this);
            if (navigator.appName == "Microsoft Internet Explorer") jQuery(this).find("> .drop").stop().css({overflow: "hidden"}).animate({height: 0}, t, function () {
                jQuery(e).removeClass("hover")
            }); else jQuery(this).find("> .drop").stop().css({overflow: "hidden"}).animate({
                height: 0,
                opacity: 0
            }, t, function () {
                jQuery(e).removeClass("hover")
        ...
        jQuery(this).find(".drop ul > li ").mouseenter(function () {
            jQuery(this).addClass("hover");
            var e = getPageSize()[2];
            if (e < jQuery(this).offset().left + 236 * 2) jQuery(this).find("> .drop").css({left: "auto", right: 236});
            if (navigator.appName == "Microsoft Internet Explorer") jQuery(this).find("> .drop").css({display: "block"}).stop().animate({width: 236}, t, function () {
                jQuery(this).css({overflow: "visible"})
            }); else jQuery(this).find("> .drop").css({display: "block"}).stop().animate({
                width: 236,
                opacity: 1
            }, t, function () {
                jQuery(this).css({overflow: "visible"})
            ...
            if (navigator.appName == "Microsoft Internet Explorer") jQuery(this).find("> .drop").stop().css({overflow: "hidden"}).animate({width: 0}, t, function () {
...
function getPageSize() {
    ...
    if (t < r) pageHeight = r; else pageHeight = t;
    if (e < n) pageWidth = n; else pageWidth = e;
                ...
                if (!a.data("sticky_kit")) {
                    ...
                    if (n !== v) return t = !1, w = void 0, c = m, k = function () {
                        ...
                        h ? (f = p + n + c > v + l, t && !f && (t = !1, a.css({
                            ...
                            width: "",
                            top: ""
                        }, a.css(b).removeClass(r).trigger("sticky_kit:unstick")), u && (b = q.height(), n > b && !t && (c -= k, c = Math.max(b - n, c), c = Math.min(m, c), h && a.css({top: c + "px"})))) : p > y && (h = !0, b = {
                            position: "fixed",
                            top: c
                        }, b.width = a.width() + "px", a.css(b).addClass(r).after(g), "left" !== s && "right" !== s || g.append(a), a.trigger("sticky_kit:stick"));
                        if (h && (null == f && (f = p + n + c > v + l), !t && f)) return t = !0, "static" === d.css("position") && d.css({position: "relative"}), a.css({
                            position: "absolute",
                            bottom: e,
                            top: ""
...
function truethemes_MobileMenu() {
    ...
    function truethemes_MobileMenu() {
        ...
        if (windowWidth <= 767) if (!jQuery("#tt-mobile-menu-button").length) {
    ...
    function tt_menu_listener() {
        ...
        jQuery("#tt-mobile-menu-list").find("> .menu-item").each(function () {
            var $this = jQuery(this), opener = $this.find("> a"), slide = $this.find("> .sub-menu")
        })
    }
...
function truethemes_MobileSubs() {
    ...
    jQuery("<option />", {"selected": "selected", "value": "", "text": "Main Menu"}).appendTo("#sub_nav select");
