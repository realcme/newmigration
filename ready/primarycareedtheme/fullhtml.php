...
<head><title>primary care education - Primary Care Education</title>
                                ...
                                <div id="content-inner">
                                    ...
                                    <div id="content-area">
                                        <div class='view view-all-activities'>
                                            <form action="http://primarycareed.realcme.com/cms/allactivities/%2A"
                                            ...
                                            <div class='view-content view-content-all-activities'>
                                                <table>
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="3" align="center" valign="top"><img
                                                                    src="http://primarycareed.realcme.com/cms/../cmsdata/course_icons/icon-marion.gif"
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="3" align="center" valign="top"><img
                                                                    src="http://primarycareed.realcme.com/cms/../cmsdata/course_icons/icon_marvin.gif"
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="3" align="center" valign="top"><img
                                                                    src="http://primarycareed.realcme.com/cms/../cmsdata/course_icons/icon_annalisa.gif"
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="3" align="center" valign="top"><img
                                                                    src="http://primarycareed.realcme.com/cms/../cmsdata/course_icons/icon_robin.gif"
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="3" align="center" valign="top"><img
                                                                    src="http://primarycareed.realcme.com/cms/../cmsdata/course_icons/icon_stan.gif"
