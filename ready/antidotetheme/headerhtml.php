...
<head><title>Antidote Education Company | STAGING</title>
    ...
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/4cf6ad9b9575ee0f36a19be98a861cb5.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://antidote.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://antidote.realcme.net/cms/../cmsdata/course_icons/icon_eleanor_0.gif"
