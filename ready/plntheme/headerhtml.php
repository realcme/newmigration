...
<head><title>PLN | STAGING</title>
    ...
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/97d97f7d674da6ef992c894bf871d896.css";</style>
    <!--[if IE]>
                        ...
                        <div id="content-inner">
                            <div id="content-area">
                                <div class='view view-all-activities'>
                                    <form action="http://pln.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                    ...
                                    <div class='view-content view-content-all-activities'>
                                        <table>
                                            ...
                                            <tr class="odd">
                                                <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                    rowspan="1" align="center" valign="top"><img
                                                            src="http://pln.realcme.net/cms/../cmsdata/course_icons/icon_cheryl.gif"
                                            ...
                                            <tr class="odd">
                                                <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                    rowspan="1" align="center" valign="top"><img
                                                            src="http://pln.realcme.net/cms/../cmsdata/course_icons/icon_raul.gif"
