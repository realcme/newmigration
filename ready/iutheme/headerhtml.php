...
<head><title>Indiana University School of Medicine | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/iutheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/09034226f17c3209dc9d68c7d0899ccf.css";</style>
    <!--[if IE]>
...
<div id="page">
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        <div id="top-header><div id=" inner-header
        ">
        <div id="top-space">
            <div class="inner">
                <div id="iu-branding"><a href="http://indiana.edu" title="Indiana University" alt="Indiana University"
                                         target="_blank"><img src="/cms/sites/all/themes/zen/iutheme/img/iu_crimson.gif"
                                                              alt="Indiana University" title="Indiana University"></a>
                </div>
            </div><!---inner---> </div>
        <div class="clear"></div>
        <div id="bottom-space">
            <div class="inner">
                <div id="top-logo"><a href="http://cme.medicine.iu.edu/index.php?cID=1"
                                      title="Division of Continuing Medical Education"> <img
                                src="/cms/sites/all/themes/zen/iutheme/img/cme-white.png"
                                title="Division of Continuing Medical Education"
                                alt="Division of Continuing Medical Education"> </a></div>
                <div class="clear"></div>
                <div id="nav">
                    <ul class="level-1 black">
                        <li><a href="http://cme.medicine.iu.edu/">Home</a></li>
                        <li><a href="http://cme.medicine.iu.edu/about-us/">About Us</a></li>
                        <li><a href="http://cme.medicine.iu.edu/mycme/">MyCME</a></li>
                        <li><a href="http://cme.medicine.iu.edu/activities/">CME Activities</a></li>
                        <li><a href="http://cme.medicine.iu.edu/courses/">Course Registration</a></li>
                        <li><a href="http://cme.medicine.iu.edu/maintenance-of-certification/">MOC</a></li>
                        <li><a href="http://cme.medicine.iu.edu/presenters/">Presenters</a></li>
                        <li><a href="http://cme.medicine.iu.edu/event-development/">Event Development</a></li>
                        <li><a href="http://cme.medicine.iu.edu/contact/">Contact</a></li>
                    </ul>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div id="content-inner">
                <div id="content-area">
                    <div class='view view-all-activities'>
                        <form action="http://iu.realcme.net/cms/allactivities" accept-charset="UTF-8" method="get"
                              id="views-filters">
                            <div>
                                <table>
                                    <thead>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td><input type="submit" id="edit-submit" value="Submit" class="form-submit"/>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class='view-content view-content-all-activities'>
                            <table>
                                ...
                                <tbody>
                                <tr class="odd">
                                    <td class="view-field view-field-node-data-field-icon-field-icon-fid" rowspan="2"
                                        align="center" valign="top"><img
                                                src="http://iu.realcme.net/cms/../cmsdata/course_icons/icon_judd_0.gif"
                                                alt="icon_judd.gif" title="icon_judd.gif" width="43" height="43"
                                                class="imagefield imagefield-field_icon"/><br/>Judd
                                    </td>
                                    <td class="view-field view-field-node-title"><a href="/cms/node/312186">Judd Visit
                                            1: A 15-year-old male with obesity</a></td>
                                    ...
                                    <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                        <span class="date-display-single"><span style="color:#aaa; font-style:italic;">05-Dec-13</span></span>
                                    </td>
                                    <td class="view-field view-field-node-data-field-series-field-series-value">judd
                                    </td>
                                </tr>
                                <tr class="even">
                                    <td class="view-field view-field-node-title"><a href="/cms/node/312204">Judd Visits
                                            2 - 3: A 15-year-old male with obesity and cardiometabolic risk factors</a>
                                    </td>
                                    <td class="view-field view-field-term-node-1-name">Pediatrics</td>
                                    <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                        Alexander Djuricich, MD
        ...
        <div id="sidebar-right">
            <div id="sidebar-right-inner">
                <div id="altcontainer2">
                    <div id="companionlogo"><img src="/cms/sites/all/themes/zen/iutheme/img/logo-companion.gif"
                                    ...
                                    <div><span class="left cmeloginregistration"> <p>These activities require <a
                                                    ...
                                                    class="left" style="padding: 10px 0px 5px 5px;"> <span
                                                        ...
                                                        onClick="$('#companion_description').slideToggle('slow'); $('#comp_info_plus').toggle(); $('#comp_info_minus').toggle();"> <span
                                                            ...
                                                            id="comp_info_minus" style="display: none; font-size: 12px"> (&ndash;)</span> <span
    ...
    <div id="footer-inner">
        <div id="footer-message">
            <center>
                ...
                <br/><br/> <img src="/cms/sites/all/themes/zen/iutheme/img/footerlogo.png" alt="" class="center"/>
            </center>
        </div>
    </div>
