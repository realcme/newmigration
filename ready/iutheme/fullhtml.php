...
<head><title>Indiana University School of Medicine</title>
            ...
            <div id="content-inner">
                <div id="content-area">
                    <div class='view view-all-activities'>
                        <form action="http://iu.realcme.com/cms/allactivities" accept-charset="UTF-8" method="get"
                              id="views-filters">
                            <div>
                                <table>
                                    <thead>
                                ...
                                <tr class="odd">
                                    <td class="view-field view-field-node-data-field-icon-field-icon-fid" rowspan="2"
                                        align="center" valign="top"><img
                                                src="http://iu.realcme.com/cms/../cmsdata/course_icons/icon_judd_0.gif"
