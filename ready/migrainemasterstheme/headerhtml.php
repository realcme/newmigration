...
<head><title>MigraineMasters | STAGING</title>
    ...
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/migrainemasterstheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/d28e69fb4f59bd6a9d1ce18cf6537ff4.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://migrainemasters.realcme.net/cms/allactivities"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://migrainemasters.realcme.net/cms/../cmsdata/course_icons/icon_485625.png"
                                                        alt="icon_485625.png" title="icon_485625.png" width="43"
                                                        height="43" class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/476200">Real
                                                    World Treatment of Multiple Sclerosis (MS)</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">20-Nov-15</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">20-Nov-16</span></span>
                                            </td>
