...
<head><title>Dannemiller | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/dannemillertheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/7de5bdcb4eeb881532febe30f7ceef45.css";</style>
    <!--[if IE]>
    ...
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="headerdanne"><a class="logodanne"
                                         style="background:url(/cms/sites/all/themes/zen/dannemillertheme/img/pain_transition_logo.png) no-repeat;"
                                         href=""></a> <!--Quick Links-->
                    <div class="quickLinks">
                        <ul>
                            <li><a href=""><img
                                            src="/cms/sites/all/themes/zen/dannemillertheme/img/practitioner_icon.png"
                                            alt="Practioner Icon"/> Professionals</a>
                                <ul class="smalldanne">
                                    <li><a href="http://cme.dannemiller.com">CME Center</a></li>
                                    <li><a href="http://cme.dannemiller.com/crna/">CRNA Center</a></li>
                                    <li><a href="http://cme.dannemiller.com/aanp/">AANP Center</a></li>
                                    <li><a href="http://cme.dannemiller.com/cme-center/abstracts/">Abstract Center</a>
                                    </li>
                                    <li><a href="http://cme.dannemiller.com/cme-center/articles/">Medical Articles</a>
                                    </li>
                                    <li><a href="http://cme.dannemiller.com/cme-center/simulations/">Interactive
                                            Simulations</a></li>
                                    <li><a href="http://cme.dannemiller.com/cme-center/slideshows/">Slideshow
                                            Presentations</a></li>
                                    <li><a href="http://www.dannemiller.com/live-events/">Meetings</a></li>
                                    <li><a href="http://store1.dannemiller.com/ConferenceRecordings.aspx">Nonaccredited
                                            Education</a></li>
                                    <li><a href="http://cme.dannemiller.com/sections/professional/products/">Education
                                            by Mail</a></li>
                                    <li><a href="http://dannemiller.learnercentral.com">Certification Coach&trade;</a>
                                    </li>
                                </ul>
                            <li><a href=""
                                   style="background:url(/cms/sites/all/themes/zen/dannemillertheme/img/divider.png) no-repeat;"></a>
                            <li></li>
                            <li><a href="">My Account</a>
                                <ul class="smalldanne">
                                    <li><a href="http://cme.dannemiller.com/login/transcripts.cfm">Transcripts</a></li>
                                    <li><a href="http://cme.dannemiller.com/login/transcripts.cfm#points">My Points
                                            Balance</a></li>
                                    <li><a href="http://cme.dannemiller.com/login/update_profile.cfm">My Profile</a>
                                    </li>
                                    <li><a href="http://cme.dannemiller.com/login/logout.cfm">Log Out</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div id="navigate">
                    <ul>
                        <li><a href="http://cme.dannemiller.com">EDUCATION CENTER HOME</a></li>
                        <li><a href="http://www.dannemiller.com/go/about/" target="_blank">ABOUT US</a></li>
                        <li><a href="http://www.dannemiller.com/go/about/contact/" target="_blank">CONTACT US</a></li>
                        <li><a href="http://www.dannemiller.com">Back to Dannemiller.com</a></li>
                    </ul>
                </div>
                <div id="banner"
                     style="background:url(/cms/sites/all/themes/zen/dannemillertheme/img/bg_banner.png) repeat-x #CDCDCD;"></div>
            </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            ...
                            <div class='view view-all-activities'>
                                <form action="http://dannemiller.realcme.net/cms/allactivities" accept-charset="UTF-8"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/dannemillertheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/dannemillertheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
