...
<head><title>The PAH Nursing Virtual Clinic | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/pahclinictheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/0c8995288e4942bdab468448355f8507.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/pahclinictheme/img/logo.gif" alt="Home"
                                    id="logo-image"/> </a></div>
                    <div style="clear:both;font-size:48px;font-family:Times New Roman;color:black"><span>The PAH Virtual Clinic.</span>
                    </div>
                    <div style="clear:both;font-size:28px;font-family:Times New Roman;color:#35C0E2;font-weight:bold">
                        <span>A structured education program specifically for healthcare providers who manage Pulmonary Artery Hypertension.</span>
                    </div>
                </div> <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://pahclinic.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://pahclinic.realcme.net/cms/../cmsdata/course_icons/icon_elena_0.gif"
                                                        alt="icon_elena.gif" title="icon_elena.gif" width="43"
                                                        height="43" class="imagefield imagefield-field_icon"/><br/>Elena
                                            </td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/155501">Elena
                                                    Visit 1: 42 year old woman with increasing dyspnea on exertion</a>
                                            </td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">31-Aug-11</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">30-Aug-12</span></span>
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/pahclinictheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/pahclinictheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
...
<div id="fundstrip">
    <div><p>This activity is supported by an educational grant from United Therapeutics Europe Limited.</p><img
                alt="United Therapeutics." src="/cms/sites/all/themes/zen/pahclinictheme/img//footer-logo-ut.png"></div>
</div>  
