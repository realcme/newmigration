...
<head><title>NACE Online | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/naceonlinetheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/c5afb894ff6ef48621a18ef98095bb58.css";</style>
    <!--[if IE]>
    ...
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo"><a href="http://www.naceonline.com" title="Home" target="_blank"><img
                                src="/cms/sites/all/themes/zen/naceonlinetheme/img/new_images/logo.png" alt="Home"
                                id="logo-image"/></a></div>
            </div>
        </div> <!-- /#header-inner, /#header -->
        <div id="top_nav">
            <ul id="top_nav_links">
                <li class=""><a href="http://naceonline.com/page_Home-Study-Courses.php" target="_blank"><span
                                id="top_nav_text">Online Mental Health CE Courses</span></a>
                    <div class="dropdown-content"><a href="#">Link 1</a> <a href="#">Link 2</a> <a href="#">Link 3</a>
                    </div>
                </li>
                <li class=""><a href="http://naceonline.com/CME-Courses/catalog.php" target="_blank"><span
                                id="top_nav_text">Online CME<br/>Courses</span></a>
                    <div class="dropdown-content"><a href="#">Link 1</a> <a href="#">Link 2</a> <a href="#">Link 3</a>
                    </div>
                </li>
                <li class=""><a href="http://naceonline.com/CME-Courses/catalog-University-of-Miami.php"
                                target="_blank"><span id="top_nav_text">State Required and Prep Courses</span></a>
                    <div class="dropdown-content"><a href="#">Link 1</a> <a href="#">Link 2</a> <a href="#">Link 3</a>
                    </div>
                </li>
                <li class=""><a href="http://naceonline.com/CME-Courses/catalog-conferences.php" target="_blank"><span
                                id="top_nav_text">Live Medical Conferences</span></a>
                    <div class="dropdown-content"><a href="#">Link 1</a> <a href="#">Link 2</a> <a href="#">Link 3</a>
                    </div>
                </li>
                <li class="" style="line-height:30px; border-right:none;"><a
                            href="http://naceonline.com/mission.php"><span id="top_nav_text">About NACE</span></a>
                    <div class="dropdown-content"><a href="#">Link 1</a> <a href="#">Link 2</a> <a href="#">Link 3</a>
                    </div>
                </li>
            </ul>
                        ...
                        <div id="content-area">
                            <div class='view view-listing-all'>
                                <div class='listing-tabs'>
                                    <form action="http://naceonline.realcme.net/cms/listingall" accept-charset="UTF-8"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/naceonlinetheme/img/logo-companion.gif"
                            ...
                            <div id="list1"> <!-- SIDEBAR RIGHT -->
                                <div><span class="left cmeloginregistration"> <p>These activities require <a
                                                    ...
                                                    href="http://naceonline.com/" id="login_link">log in</a>.</p> <div
        ...
        <div id="footer">
            <center>
                <small> ©COPYRIGHT 2016. NATIONAL ASSOCIATION FOR CONTINUING EDUCATION INC., ALL RIGHTS RESERVED.
                </small>
            </center>
            <br/> <br/>
            <center>
                <small> Copyright © RealCME, LLC 2008-2016. All Rights Reserved. <a href="/cms/privacypolicy">Privacy
