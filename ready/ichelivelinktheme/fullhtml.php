...
<head><title>Institute for Continuing Healthcare Education - Live Link</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/ichelivelinktheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/b2c0155ff8de312b91fa169da617399c.css";</style>
    <!--[if IE]>
...
<div id="page">
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/ichelivelinktheme/img/logo.png" alt="Home"
                                    id="logo-image" width="175"/></a></div>
                </div> <!-- /#logo-title -->
                <table cellspacing="0" cellpadding="0" border="0" class="right">
                    <tr>
                        <td><img width="7" height="40" src="/cms/sites/all/themes/zen/ichelivelinktheme/img/space.gif"
                                 alt=""></td>
                        <td bgcolor="#f1f2f4"><img width="130" height="40"
                                                   src="/cms/sites/all/themes/zen/ichelivelinktheme/img/space.gif"
                                                   alt=""></td>
                        <td><img width="7" height="40" src="/cms/sites/all/themes/zen/ichelivelinktheme/img/space.gif"
                                 alt=""></td>
                        <td bgcolor="#dddee2"><img width="130" height="40"
                                                   src="/cms/sites/all/themes/zen/ichelivelinktheme/img/space.gif"
                                                   alt=""></td>
                        <td><img width="7" height="40" src="/cms/sites/all/themes/zen/ichelivelinktheme/img/space.gif"
                                 alt=""></td>
                        <td bgcolor="#babdc2"><img width="135" height="40"
                                                   src="/cms/sites/all/themes/zen/ichelivelinktheme/img/space.gif"
                                                   alt=""></td>
                        <td><img width="7" height="40" src="/cms/sites/all/themes/zen/ichelivelinktheme/img/space.gif"
                                 alt=""></td>
                        <td bgcolor="#969da5" align="right"><img width="135" height="40"
                                                                 src="/cms/sites/all/themes/zen/ichelivelinktheme/img/space.gif"
                                                                 alt=""></td>
                    </tr>
                </table>
                <!-- <div style="clear: both" id="header_bar"><img width="330" src="/cms/sites/all/themes/zen/ichelivelinktheme/img/topbanner.jpg" alt=""></div> -->
            </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://ichelivelink.realcme.com/cms/allactivities" accept-charset="UTF-8"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/ichelivelinktheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/ichelivelinktheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
    ...
    <div id="iche-footer"><a target="ifrmContent" href="text/text_home_Copyright.aspx" onclick="linkOnClick('')"
                             class="bottom_nav" id="lnkCopyright"><span id="lblCopyrightDate">Copyright &copy; 1997&ndash;2018 </span>
            Institute for Continuing Healthcare Education, Inc.</a> <a style="display: none;" class="bottom_nav"
                                                                       id="lnkTermsOfUse">Terms of use</a> <a
                style="display: none;" class="bottom_nav" id="lnkPrivacyPolicy">Privacy policy</a>&nbsp;&nbsp;
    </div>
