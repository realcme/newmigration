...
<head><title>Prostate e-Clinic | Arcmesa Prostate Cancer</title>
    ...
    <script type="text/javascript"> var width, top = window;
        ...
        vc - ' + visit.nid, visit.clinicnid, { path: ' / ', domain: '.realcme.com
                                ...
                                <div id="related-activities">
                                    ...
                                    <div class="related-activities-left testing">
                                            ...
                                            <div class="node-inner">
                                                <div class="rcmcontent">
                                                    ...
                                                    <div class="activity-subject">
                                                        ...
                                                        <div class="certified-text">Hematology-Oncology</div>
                                                    </div>
                                        ...
                                        <script type="text/javascript"
                                                language="javascript"> <!-- $(document).ready(function() { $('#lt-3186').click(function(){ $.cookie('vc-3186', 2592, { path: '/', domain: '.realcme.com' }); }); $('#lp-3186').click(function(){ $.cookie('vc-3186', 2592, { path: '/', domain: '.realcme.com' }); }); $('#ls-3186').click(function(){ $.cookie('vc-3186', 2592, { path: '/', domain: '.realcme.com' }); }); }); --> </script>
                                    </div>
                                </div> <!-- END PROMO -->
                                <div style="clear: both;"></div>
                            </div>
