...
<head><title>American Journal of Medicine</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/amjmedtheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/9d3a5c9e705c3e7038bae8149e4344be.css";</style>
    <!--[if IE]>
...
<div class="page-header"><a href="/cms/../" title="Home" rel="home"><img
                src="/cms/sites/all/themes/zen/amjmedtheme/img/amjmed_logo.jpg" alt="Home" id="logo-image"/></a></div>
<div id="page">
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        <div id="skip-to-nav"><a href="#navigation">Skip to Navigation</a></div>
        <div id="header">
            <div id="header-inner" class="clear-block">
                <!-- <div id="logo-title"> <div id="logo"><a href="/cms/../" title="Home" rel="home"><img src="/cms/sites/all/themes/zen/amjmedtheme/img/logo.gif" alt="Home" id="logo-image" /></a></div> </div> -->
                <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://amjmed.realcme.com/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://amjmed.realcme.com/cms/../cmsdata/course_icons/icon_412117.png"
                                                        alt="icon_412117.png" title="icon_412117.png" width="43"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://amjmed.realcme.com/cms/../cmsdata/course_icons/icon_409793.png"
                                                        alt="icon_409793.png" title="icon_409793.png" width="43"
                                                        height="43" class="imagefield imagefield-field_icon"/><br/></td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/amjmedtheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/amjmedtheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
...
<div class="page-footer"><p>Copyright &copy; 2014 <a href="http://www.elsevier.com">Elsevier Inc.</a> All rights
        reserved. <a href="http://www.elsevier.com/legal/privacy-policy">Privacy Policy</a>.&nbsp; <a
                href="http://www.elsevier.com/termsandconditions">Terms and Conditions</a>.<br/> Click here to visit the
        <a href="http://www.elseviercme.com">Elsevier CME website.</a> <a href="http://www.elseviercme.com/contact-us">Contact
            Us</a> <br/></div>
</body>
</html>
