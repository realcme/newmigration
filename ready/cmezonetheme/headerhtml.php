...
<head><title>CME Zone | STAGING</title>
                ...
                <div id="content-inner">
                    <div id="content-area">
                        <div class='view view-all-activities'>
                            <form action="http://cmezone.realcme.net/cms/allactivities" accept-charset="UTF-8"
                            ...
                            <div class='view-content view-content-all-activities'>
                                <table>
                                    ...
                                    <tr class="odd">
                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                            rowspan="1" align="center" valign="top"><img
                                                    src="http://cmezone.realcme.net/cms/../cmsdata/course_icons/icon.jpg"
                                    ...
                                    <tr class="odd">
                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                            rowspan="1" align="center" valign="top"><img
                                                    src="http://cmezone.realcme.net/cms/../cmsdata/course_icons/icon_gregory.gif"
                                    ...
                                    <tr class="odd">
                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                            rowspan="1" align="center" valign="top"><img
                                                    src="http://cmezone.realcme.net/cms/../cmsdata/course_icons/icon_jeffrey.gif"
                                    ...
                                    <tr class="odd">
                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                            rowspan="1" align="center" valign="top"><img
                                                    src="http://cmezone.realcme.net/cms/../cmsdata/course_icons/ThrombinIcon4.jpeg"
                                    ...
                                    <tr class="odd">
                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                            rowspan="2" align="center" valign="top"><img
                                                    src="http://cmezone.realcme.net/cms/../cmsdata/course_icons/icon_timothy.gif"
