...
<head><title>AXIS Medical Education Breast Cancer | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/acebctheme/print.css" type="text/css" media="print"/>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/5e645f14c7a4ed1e1b84b94279712e03.css";</style>
    <!--[if IE]>
    ...
    <script type="text/javascript" src="/cms/sites/all/themes/zen/acebctheme/js/axismeded.js"></script>
...
<body class="not-front not-logged-in two-sidebars page-listingall section-listingall">
<div id="page">
    <div id="page-inner"><a name="top" id="navigation-top"></a>
        ...
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo"><a href="/cms/" title="Home" rel="home"><img
                                src="/cms/sites/all/themes/zen/acebctheme/img/new_images/Header.jpg" alt="Home"
                                id="logo-image"/></a></div>
            </div>
                ...
                <nav id="main-menu" role="navigation">
                    <ul class="menu">
                        ...
                        <li class="menu__item is-active-trail is-expanded expanded active-trail"><a
                                    href="http://axismeded.com/content/about-us" class="menu__link">About Us</a>
                            <ul class="menu">
                        ...
                        <div id="content-area">
                            <div class='view view-listing-all'>
                                <div class='listing-tabs'>
                                    <form action="http://acebc.realcme.net/cms/listingall" accept-charset="UTF-8"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/acebctheme/img/logo-companion.gif"
        ...
        <section id="footer-menu">
            <div class="container">
                ...
                <p>&copy; 2018 AXIS Medical Education, Inc. (AXIS). All rights reserved.</p>
