...
<head><title>Humedica | STAGING</title>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://humedica-joslin.realcme.net/cms/allactivities"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://humedica-joslin.realcme.net/cms/../cmsdata/course_icons/icon__71.png"
