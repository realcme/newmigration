...
<head><title>Accelmed (ALZ) | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/alz-accelmedtheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/593d07af0935db88c2a77e7a7ef5cb4c.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/alz-accelmedtheme/img/alz-logo.jpg" alt="Home"
                                    id="logo-image"/></a></div>
                </div> <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://alz-accelmed.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://alz-accelmed.realcme.net/cms/../cmsdata/course_icons/icon_cyrus.gif"
                                                        alt="icon_cyrus.gif" title="icon_cyrus.gif" width="43"
                                                        height="43" class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/438919">Alzheimer&#039;s
                                                    Disease: Utilization of Novel Diagnostic Tools and a Better
                                                    Understanding of Emerging Pharmacotherapies</a></td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://alz-accelmed.realcme.net/cms/../cmsdata/course_icons/icon__85.png"
                                                        alt="icon_.png" title="icon_.png" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/425432">Perspective
                                                    on Alzheimer&#039;s: Current and Emerging Diagnostics and Therapies
                                                    Enduring Web Archive</a></td>
                                            <td class="view-field view-field-term-node-1-name">Neurology</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                James B. Brewer, MD, PhD
                                            </td>
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">30-Jul-13</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                1.25&nbsp;AMA<br/>1.25&nbsp;CA-BRN<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">30-Jul-14</span></span>
                                            </td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                308769
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/alz-accelmedtheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/alz-accelmedtheme/img/footerlogo.png" alt=""
                                        class="center"/> <br/> <br/>
                        <p>
                            <small><img src="/cms/sites/all/themes/zen/alz-accelmedtheme/img/alz-footer.jpg" alt=""
                                        class="center"/></small>
                        </p>
                    </center>
                </div>
