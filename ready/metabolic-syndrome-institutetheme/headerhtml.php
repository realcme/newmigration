...
<head><title>Metabolic Syndrome Institute | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/metabolic-syndrome-institutetheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/fca68fa35b67ed8384a59c6c0d02c7d3.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/metabolic-syndrome-institutetheme/img/msi-logo.png"
                                    alt="Home" id="logo-image"/></a>
                        <div style="clear: both;"></div>
                        <div class="msi"><a href="http://www.metabolic-syndrome-institute.org/">Metabolic Syndrome
                                Institute</a></div>
                    </div>
                </div> <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://metabolic-syndrome-institute.realcme.net/cms/allactivities"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://metabolic-syndrome-institute.realcme.net/cms/../cmsdata/course_icons/icon-rosita.gif"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/metabolic-syndrome-institutetheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img
                                src="/cms/sites/all/themes/zen/metabolic-syndrome-institutetheme/img/footerlogo.png"
