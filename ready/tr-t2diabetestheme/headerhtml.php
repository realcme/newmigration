...
<head><title>Type 2 Diabetes Mellitus | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/tr-t2diabetestheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/c01882b19e85fe9018ff164ecdd1669a.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/tr-t2diabetestheme/img/ada_header.jpg" alt="Home"
                                    id="logo-image"/></a></div>
                </div> <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://tr-t2diabetes.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://tr-t2diabetes.realcme.net/cms/../cmsdata/course_icons/T2DMicon.png"
                                                        alt="T2DMicon.png" title="T2DMicon.png" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/159109">Individualized
                                                    Medicine in Managing Patients with T2DM: Enduring Archive
                                                    Webcast</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">12-Sep-11</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">12-Sep-12</span></span>
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/tr-t2diabetestheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/tr-t2diabetestheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
                <img src="/cms/sites/all/themes/zen/tr-t2diabetestheme/img/ada_footer.jpg" usemap="#Map" border="0">
                <map name="Map" id="Map">
                    ...
                    <area shape="rect" coords="517,8,681,73" href="http://www.lilly.com/Pages/home.aspx "
                          target="_blank"/>
                    <area shape="rect" coords="758,18,923,64"
                          href="http://thomsonreuters.com/products_services/healthcare/ " target="_blank"/>
