...
<head><title>Current Psychiatry | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/currentpsychiatrytheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/877d9d05b22eb15a64c635700cc2ff04.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/currentpsychiatrytheme/img/curr_psych_logo.gif"
            ...
            <div id="main-inner" class="clear-block with-navbar">
                <div id="content">
                    <div id="content-inner">
                        <div id="content-area">
                            <div style="font-size:16px;"> Virtual Clinic Powered by RealCME with content provided by its
                                educational partners
                            </div>
                            <div class='view view-all-activities'>
                                <form action="http://currentpsychiatry.realcme.net/cms/allactivities"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.net/cms/../cmsdata/course_icons/icon_andrew.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.net/cms/../cmsdata/course_icons/hi_NCI601.jpg"
                                                        alt="hi_NCI601.jpg" title="hi_NCI601.jpg" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/203383">Identifying
                                                    and Managing Patients with Mixed States in Bipolar Disorder</a></td>
                                            <td class="view-field view-field-term-node-1-name">Psychiatry</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Michael H. Allen, MD
                                            </td>
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.net/cms/../cmsdata/course_icons/icon_jason.gif"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="3" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.net/cms/../cmsdata/course_icons/icon_lisa.gif"
                                                        alt="icon_lisa.gif" title="icon_lisa.gif" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/>Lisa
                                            </td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/81500">Lisa
                                                    Visit 1: A woman with bipolar disorder who wants a second
                                                    opinion</a></td>
                                            <td class="view-field view-field-term-node-1-name">Psychiatry</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Holly A. Swartz, MD
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">24-Jan-11</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                1&nbsp;AMA<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">24-Jan-12</span></span>
                                            </td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                lisa
                                            </td>
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-title"><a href="/cms/node/120430">Lisa
                                                    Visit 2: A woman with bipolar disorder who has switched mood
                                                    stabilizers in order to lose weight</a></td>
                                            <td class="view-field view-field-term-node-1-name">Psychiatry</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Holly A. Swartz, MD
                                            </td>
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">25-May-11</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                1&nbsp;AMA<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">25-May-12</span></span>
                                            </td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                lisa
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-title"><a href="/cms/node/142339">Lisa
                                                    Visit 3: A woman with bipolar disorder who may be experiencing side
                                                    effects due to her current pharmacological treatment</a></td>
                                            <td class="view-field view-field-term-node-1-name">Psychiatry</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Holly A. Swartz, MD
                                            </td>
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">22-Jul-11</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                1&nbsp;AMA<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">21-Jul-12</span></span>
                                            </td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                lisa
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.net/cms/../cmsdata/course_icons/icon-maryanne.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.net/cms/../cmsdata/course_icons/hi_NCI601_0.jpg"
                                                        alt="hi_NCI601.jpg" title="hi_NCI601.jpg" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/203591">Metabolic
                                                    Comorbidities in Patients with Bipolar Disorder</a></td>
                                            <td class="view-field view-field-term-node-1-name">Psychiatry</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Roger S. McIntyre, MD, FRCPC
                                            </td>
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">06-Jan-12</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                0.5&nbsp;AMA<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">05-Jan-13</span></span>
                                            </td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                Bipolar-EA
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/currentpsychiatrytheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/currentpsychiatrytheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
