...
<head><title>Current Psychiatry</title>
    ...
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/currentpsychiatrytheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/78bdbcdbf41c0fdbe42827cd088ec140.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            ...
                            <div class='view view-all-activities'>
                                <form action="http://currentpsychiatry.realcme.com/cms/allactivities"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.com/cms/../cmsdata/course_icons/icon_andrew.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.com/cms/../cmsdata/course_icons/hi_NCI601.jpg"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.com/cms/../cmsdata/course_icons/icon_jason.gif"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="3" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.com/cms/../cmsdata/course_icons/icon_lisa.gif"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.com/cms/../cmsdata/course_icons/icon-maryanne.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://currentpsychiatry.realcme.com/cms/../cmsdata/course_icons/hi_NCI601_0.jpg"
                                                        alt="hi_NCI601.jpg" title="hi_NCI601.jpg" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
