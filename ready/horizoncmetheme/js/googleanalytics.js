// rcmeId: googleanalytics.js,v 1.1 2009-06-02 20:34:44 palle Exp rcme

Drupal.gaTrackerAttach = function (context) {
    context = context || document;

    rcme('a', context).click(function () {
        var ga = Drupal.settings.googleanalytics;
        // Expression to check for absolute internal links.
        var isInternal = new RegExp("^(https?):\/\/" + window.location.host, "i");
        // Expression to check for special links like gotwo.module /go/* links.
        var isInternalSpecial = new RegExp("(\/go\/.*)rcme", "i");
        // Expression to check for download links.
        var isDownload = new RegExp("\\.(" + ga.trackDownloadExtensions + ")rcme", "i");
        ...
        try {
            ...
            if (isInternal.test(this.href)) {
                ...
                if (ga.trackMailto && rcme(this).is("a[@href^=mailto:]")) {
                    // Mailto link clicked.
                    if (ga.LegacyVersion) {
