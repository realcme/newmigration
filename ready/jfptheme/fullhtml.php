...
<head><title>Journal of Family Practice</title>
    ...
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/611b1db80e1e40e638a47a3485115344.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            ...
                            <div class='view view-all-activities'>
                                <form action="http://jfp.realcme.com/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://jfp.realcme.com/cms/../cmsdata/course_icons/icon-harry.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="3" align="center" valign="top"><img
                                                        src="http://jfp.realcme.com/cms/../cmsdata/course_icons/icon-marion.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://jfp.realcme.com/cms/../cmsdata/course_icons/iStock_000006926155_0.jpg"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://jfp.realcme.com/cms/../cmsdata/course_icons/lungs.png"
