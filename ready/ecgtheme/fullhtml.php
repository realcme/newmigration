...
<head><title>Educational Concepts Group</title>
    ...
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/5829f20bc0a5ea70b370a0498d1d06c3.css";</style>
    <!--[if IE]>
                                ...
                                <div id="content-inner">
                                    <div id="content-area">
                                        <div class='view view-all-activities'>
                                            <form action="http://ecg.realcme.com/cms/allactivities"
                                            ...
                                            <div class='view-content view-content-all-activities'>
                                                <table>
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="1" align="center" valign="top"><img
                                                                    src="http://ecg.realcme.com/cms/../cmsdata/course_icons/icon__16.gif"
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="1" align="center" valign="top"><img
                                                                    src="http://ecg.realcme.com/cms/../cmsdata/course_icons/icon_katrina.gif"
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="1" align="center" valign="top"><img
                                                                    src="http://ecg.realcme.com/cms/../cmsdata/course_icons/icon__5.gif"
                                                                    alt="icon_.gif" title="icon_.gif" width="43"
                                                                    height="43"
                                                                    class="imagefield imagefield-field_icon"/><br/></td>
                                                        <td class="view-field view-field-node-title"><a
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="1" align="center" valign="top"><img
                                                                    src="http://ecg.realcme.com/cms/../cmsdata/course_icons/icon__4.gif"
                                                                    alt="icon_.gif" title="icon_.gif" width="43"
                                                                    height="43"
                                                                    class="imagefield imagefield-field_icon"/><br/></td>
                                                        <td class="view-field view-field-node-title"><a
                                                    ...
                                                    <tr class="odd">
                                                        <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                            rowspan="1" align="center" valign="top"><img
                                                                    src="http://ecg.realcme.com/cms/../cmsdata/course_icons/icon__8.gif"
                                                                    alt="icon_.gif" title="icon_.gif" width="43"
                                                                    height="43"
                                                                    class="imagefield imagefield-field_icon"/><br/></td>
                                                        <td class="view-field view-field-node-title"><a
