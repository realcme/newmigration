...
<head><title>Treatment Resistant Depression | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/trdcmetheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/a12ec120a7dca6db8ec3eb1fb4fd73df.css";</style>
    <!--[if IE]>
...
<div id="page">
    <div id="page-inner"><a name="top" id="navigation-top"></a>
            ...
            <div id="header-inner" class="clear-block">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin: 0; padding:0;">
                    <tr valign="top" bgcolor="#ffffff" align="left">
                        <td class="main_talble"><a class="headerLink" href="http://www.trdcme.com/home.htm"><img
                                        width="143" height="15" class="logo"
                                        src="/cms/sites/all/themes/zen/trdcmetheme/img/trd_logo.png"/></a> <span
                                    class="top_nav"> <span class="top_nav"> <a href="http://www.trdcme.com/home.htm">Home</a> &nbsp;&nbsp;&nbsp; <a
                                            class="headerLink" href="http://www.trdcme.com/about_trd.htm">About Treatment-Resistant Depression</a> &nbsp;&nbsp;&nbsp; <a
                                            class="headerLink" href="http://www.trdcme.com/about_hopkins.htm">About Hopkins</a> &nbsp;&nbsp;&nbsp; <a
                                            class="headerLink" href="http://www.trdcme.com/about_bcm.htm">About BCM</a> &nbsp;&nbsp;&nbsp; <a
                                            class="headerLink"
                                            href="http://www.trdcme.com/about_dbsa.htm">About DBSA</a> </span>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://trdcme.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://trdcme.realcme.net/cms/../cmsdata/course_icons/icon-barbara.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://trdcme.realcme.net/cms/../cmsdata/course_icons/icon-tracey.gif"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/trdcmetheme/img/logo-companion.gif"
        ...
        <div style="text-align: center;"><img width="670" height="90"
                                              src="/cms/sites/all/themes/zen/trdcmetheme/img/sponsor.png"></div>
        <div id="footer">
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/trdcmetheme/img/footerlogo.png" alt=""
                                        class="center"/></center>
                </div>
            </div>
