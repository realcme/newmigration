...
<head><title>Accelmed (ACS) | STAGING</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/acs-accelmedtheme/print.css" type="text/css" media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/d6c88ce1cbfde7ad1815f729e55049eb.css";</style>
    <!--[if IE]>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/acs-accelmedtheme/img/acs-logo.jpg" alt="Home"
                                    id="logo-image"/></a></div>
                </div> <!-- /#logo-title --> </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://acs-accelmed.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://acs-accelmed.realcme.net/cms/../cmsdata/course_icons/icon_1.jpg"
                                                        alt="icon.jpg" title="icon.jpg" width="42" height="42"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/228803">Factors
                                                    that May Influence the Choice of Antiplatelet Therapy: A Clinical
                                                    Case Discussion and Current Guidelines</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">22-Mar-12</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">21-Mar-13</span></span>
                                            </td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                Accelmed-factors-ap-DP
                                            </td>
                                        </tr>
                                        <tr class="even">
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://acs-accelmed.realcme.net/cms/../cmsdata/course_icons/icon_alpeshnaminmdmbamacp_0.gif"
                                                        alt="icon_alpeshnaminmdmbamacp.gif"
                                                        title="icon_alpeshnaminmdmbamacp.gif" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/>Alpesh N. Amin,
                                                MD, MBA, MACP,
                                            </td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/411813">Hospital
                                                    Consultations in Hyponatremia: Appropriate Diagnosis and Effective
                                                    Treatment to Improve Patient Outcomes: Carl, Margret</a></td>
                                            <td class="view-field view-field-term-node-1-name">Nephrology</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Alpesh N. Amin, MD, MBA, MACP, SFHM
                                            </td>
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">12-Jun-13</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                0.5&nbsp;AMA<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://acs-accelmed.realcme.net/cms/../cmsdata/course_icons/icon_2.jpg"
                                                        alt="icon.jpg" title="icon.jpg" width="42" height="42"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/228821">Weighing
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/acs-accelmedtheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/acs-accelmedtheme/img/footerlogo.png" alt=""
                                        class="center"/> <br/> <br/>
                        <p>
                            <small><img src="/cms/sites/all/themes/zen/acs-accelmedtheme/img/acs-footer.jpg" alt=""
                                        class="center"/></small>
                        </p>
                    </center>
                </div>
