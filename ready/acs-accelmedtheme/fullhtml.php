...
<head><title>Accelmed (ACS)</title>
    ...
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/e4f1c02319fd52c8318718ced9666292.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://acs-accelmed.realcme.com/cms/allactivities" accept-charset="UTF-8"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://acs-accelmed.realcme.com/cms/../cmsdata/course_icons/icon_1.jpg"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://acs-accelmed.realcme.com/cms/../cmsdata/course_icons/icon_alpeshnaminmdmbamacp_0.gif"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://acs-accelmed.realcme.com/cms/../cmsdata/course_icons/icon_2.jpg"
                                                        alt="icon.jpg" title="icon.jpg" width="42" height="42"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
