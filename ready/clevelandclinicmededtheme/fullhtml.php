...
<head><title>Cleveland Clinic</title>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://clevelandclinicmeded.realcme.com/cms/allactivities"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="3" align="center" valign="top"><img
                                                        src="http://clevelandclinicmeded.realcme.com/cms/../cmsdata/course_icons/icon-sue.gif"
