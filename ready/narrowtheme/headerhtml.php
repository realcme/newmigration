...
<head><title>Narrow | STAGING</title>
    ...
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/ad13e47313e4d6fc4f86535eb201b552.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://narrow.realcme.net/cms/allactivities" accept-charset="UTF-8"
                                    ...
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td rowspan="2" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-alex.gif"
                                            ...
                                            <td colspan="5" align="left" class="view-field mainrow"><a
                                                        href="/cms/node/1737">Alex Visit 1: A Community-Based Primary
                                                    Care Physician with a Hospital Practice</a></td>
                                        </tr>
                                        <tr class="even">
                                            <td class="view-field view-field-node-title"></td>
                                        ...
                                        <tr class="even">
                                            <td rowspan="4" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-alice.gif"
                                        ...
                                        <tr class="odd">
                                            <td rowspan="2" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-bethany.gif"
                                        ...
                                        <tr class="even">
                                            <td rowspan="2" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-caroline.gif"
                                        ...
                                        <tr class="odd">
                                            <td rowspan="2" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-claire.gif"
                                        ...
                                        <tr class="even">
                                            <td rowspan="2" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-ella.gif"
                                                        alt="icon-ella.gif" title="icon-ella.gif" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/>Ella
                                            </td>
                                            <td class="view-field view-field-node-title"></td>
                                            <td colspan="5" align="left" class="view-field mainrow"><a
                                                        href="/cms/node/1740">Ella Visit 1: An Inner-City Police Officer
                                                    Recently Transferred to the Night Shift</a></td>
                                        </tr>
                                        <tr class="odd">
                                            <td class="view-field view-field-node-title"></td>
                                            <td class="view-field view-field-term-node-1-name">Sleep Disorders</td>
                                        ...
                                        <tr class="odd">
                                            <td rowspan="2" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-grace.gif"
                                        ...
                                        <tr class="even">
                                            <td rowspan="2" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-kendra.gif"
                                        ...
                                        <tr class="odd">
                                            <td rowspan="4" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-laura.gif"
                                        ...
                                        <tr class="even">
                                            <td rowspan="4" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-melanoma.gif"
                                        ...
                                        <tr class="odd">
                                            <td rowspan="4" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-marie.gif"
                                        ...
                                        <tr class="even">
                                            <td rowspan="2" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-flu.gif"
                                        ...
                                        <tr class="odd">
                                            <td rowspan="4" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-robert.gif"
                                        ...
                                        <tr class="even">
                                            <td rowspan="4" align="center" valign="top"><img
                                                        src="http://narrow.realcme.net/cms/../cmsdata/course_icons/icon-sarah.gif"
