...
<head><title>HealthMatters CME | STAGING</title>
    ...
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/healthmatterscmetheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/944d9dfd122d2fbf6f41cc9c39b516d4.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        ...
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://healthmatterscme.realcme.net/cms/allactivities"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://healthmatterscme.realcme.net/cms/../cmsdata/course_icons/icon__168.png"
                                                        alt="icon_.png" title="icon_.png" width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/474676">Simple
                                                    Demo Activity</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">21-Oct-16</span></span>
                                            </td>
