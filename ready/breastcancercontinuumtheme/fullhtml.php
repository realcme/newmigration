...
<head><title>Breast Cancer Continuum</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/breastcancercontinuumtheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/5b597b4bc14a14d017d7b7c380aa879a.css";</style>
    <!--[if IE]>
    ...
    <script type="text/javascript" src="/cms/sites/all/themes/zen/breastcancercontinuumtheme/js/axismeded.js"></script>
            ...
            <div id="header-inner" class="clear-block">
                <div id="logo-title" style="clear:both">
                    <div id="logo"><a href="/cms/../" title="Home" rel="home"><img
                                    src="/cms/sites/all/themes/zen/breastcancercontinuumtheme/img/axis_pim_header.png"
                                    alt="Home" id="logo-image"/></a></div>
                </div>
            </div>
        </div> <!-- /#header-inner, /#header --> <!-- BEGIN MAIN NAVIGATION -->
        <div id="axismedednavmain">
            <div id="axismedednavmainwrapper">
                <nav>
                    <ul class="grid_9">
                        <li>
                            <a href="http://axismeded.com/visitor/axis-medical-education-continuing-education-for-physicians-nurses-and-other-health-professionals?en,0,,758"
                               class="topNavItem ">HOME</a></li>
                        <li><a href="" class="topNavItem ">ABOUT US</a>
                            <div style="display: none;" class="subnavdropdown">
                                <div class="grid_2 dropdownCallout noBorder">
                                    <ul>
                                        <li><a href="http://axismeded.com/visitor/axis-who-we-are?en,0,,758" title="">Who
                                                We Are</a></li>
                                        <li><a href="http://axismeded.com/visitor/axis-advocacy?en,0,,758" title="">Advocacy</a>
                                        </li>
                                        <li><a href="http://axismeded.com/visitor/axis-about-us?en,0,,758" title="">About
                                                Us</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://breastcancercontinuum.realcme.com/cms/allactivities"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://breastcancercontinuum.realcme.com/cms/../cmsdata/course_icons/1145_RealCME_WebIcon.jpg"
                                                        alt="1145_RealCME_WebIcon.jpg" title="1145_RealCME_WebIcon.jpg"
                                                        width="43" height="43"
                                                        class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/545876">The
                                                    Breast Cancer Continuum: Intersecting Current and Novel Treatment
                                                    Strategies In Clinical Practice</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">04-Sep-14</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">16-Nov-15</span></span>
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://breastcancercontinuum.realcme.com/cms/../cmsdata/course_icons/icon_421084.jpg"
                                                        alt="icon_421084.jpg" title="icon_421084.jpg" width="43"
                                                        height="43" class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/576493">The
                                                    Breast Cancer Continuum Virtual Study Sessions</a></td>
                                            <td class="view-field view-field-term-node-1-name">Hematology-Oncology</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Edith A. Perez, MD
                                            </td>
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">15-Jan-15</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                1&nbsp;AMA<br/>1&nbsp;ANCC<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single"><span
                                                            style="color:#aaa; font-style:italic;">14-Jan-16</span></span>
                                            </td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                421084
                                            </td>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/breastcancercontinuumtheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img src="/cms/sites/all/themes/zen/breastcancercontinuumtheme/img/footerlogo.png"
        ...
        <div id="axisfooter"><a
            ...
            <a href="http://axismeded.com/visitor/axis-about-us?en,0,,758">About Us</a> <a
                    ...
                    href="https://www.facebook.com/"><img
                        src="/cms/sites/all/themes/zen/breastcancercontinuumtheme/img/axis_facebook.png" alt=""/></a> <a
                    href="https://twitter.com/"><img
                        src="/cms/sites/all/themes/zen/breastcancercontinuumtheme/img/axis_twitter.png" alt=""/></a>
