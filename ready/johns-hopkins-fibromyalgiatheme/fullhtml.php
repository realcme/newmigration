...
<head><title>Johns Hopkins</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.com/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/johns-hopkins-fibromyalgiatheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/74b5472d59c6c49ae90e3781e905a69a.css";</style>
    <!--[if IE]>
...
<div id="header">
    <div id="header-inner" class="clear-block">
        <div id="logo-title">
            <div id="jhulogo"><a href="/cms/" title="Home" rel="home"><img
                            src="/cms/sites/all/themes/zen/johns-hopkins-fibromyalgiatheme/img/logo.png" alt="Home"
                            id="logo-image"/></a></div>
        </div> <!-- /#logo-title -->
        <div id="jhulogolow"></div>
    </div>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://johns-hopkins-fibromyalgia.realcme.com/cms/allactivities"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://johns-hopkins-fibromyalgia.realcme.com/cms/../cmsdata/course_icons/icon_535229.jpg"
                                                        alt="icon_535229.jpg" title="icon_535229.jpg" width="43"
                                                        height="34" class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/809897">A
                                                    Collaborative Care Approach to Managing Depression in Primary
                                                    Care</a></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">05-Sep-17</span></td>
                                            ...
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single">04-Sep-19</span></td>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="1" align="center" valign="top"><img
                                                        src="http://johns-hopkins-fibromyalgia.realcme.com/cms/../cmsdata/course_icons/icon_535359.jpg"
                                                        alt="icon_535359.jpg" title="icon_535359.jpg" width="43"
                                                        height="34" class="imagefield imagefield-field_icon"/><br/></td>
                                            <td class="view-field view-field-node-title"><a href="/cms/node/811969">Challenges
                                                    in the Primary Care of Depression: A Patient Huddle Activity</a>
                                            </td>
                                            <td class="view-field view-field-term-node-1-name">Psychiatry</td>
                                            <td class="view-field view-field-node-data-field-faculty-field-faculty-value">
                                                Michael Clark, MD
                                            ...
                                            <td class="view-field view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                <span class="date-display-single">14-Sep-17</span></td>
                                            <td class="view-field view-field-node-data-field-all-credits-field-all-credits-value">
                                                0.5&nbsp;AMA<br/></td>
                                            <td class="view-field view-field-node-data-field-credit-expire-field-credit-expire-value">
                                                <span class="date-display-single">13-Sep-19</span></td>
                                            <td class="view-field view-field-node-data-field-series-field-series-value">
                                                535359
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://johns-hopkins-fibromyalgia.realcme.com/cms/../cmsdata/course_icons/fibro_avatar_0.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://johns-hopkins-fibromyalgia.realcme.com/cms/../cmsdata/course_icons/icon-pamela.gif"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://johns-hopkins-fibromyalgia.realcme.com/cms/../cmsdata/course_icons/icon-sarah.gif"
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/johns-hopkins-fibromyalgiatheme/img/logo-companion.gif"
            ...
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        ...
                        <br/><br/> <img
                                src="/cms/sites/all/themes/zen/johns-hopkins-fibromyalgiatheme/img/footerlogo.png"
