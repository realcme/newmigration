...
<head><title>Johns Hopkins | STAGING</title>
    ...
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/johns-hopkins-fibromyalgiatheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/72130bd16edf23886e2014f36a942f9f.css";</style>
    <!--[if IE]>
                    ...
                    <div id="content-inner">
                        <div id="content-area">
                            <div class='view view-all-activities'>
                                <form action="http://johns-hopkins-fibromyalgia.realcme.net/cms/allactivities"
                                ...
                                <div class='view-content view-content-all-activities'>
                                    <table>
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://johns-hopkins-fibromyalgia.realcme.net/cms/../cmsdata/course_icons/fibro_avatar_0.gif"
                                        ...
                                        <tr class="even">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://johns-hopkins-fibromyalgia.realcme.net/cms/../cmsdata/course_icons/icon-pamela.gif"
                                        ...
                                        <tr class="odd">
                                            <td class="view-field view-field-node-data-field-icon-field-icon-fid"
                                                rowspan="2" align="center" valign="top"><img
                                                        src="http://johns-hopkins-fibromyalgia.realcme.net/cms/../cmsdata/course_icons/icon-sarah.gif"
