...
<head><title>ModernMedicine | STAGING - Modern Medicine</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link rel="shortcut icon" href="http://i.realcme.net/cms/favicon.ico" type="image/x-icon"/>
    <link rel="stylesheet" href="/cms/sites/all/themes/zen/modernmedicinetheme/print.css" type="text/css"
          media="print"/>
    <style type="text/css" media="all">@import "/cms/../cmsdata/css/4dafe24f4b25d37abcdfc6e4613b8e5f.css";</style>
    <!--[if IE]>
    ...
    <script language="javascript"> function _hbxStrip(a) {
            a = a.split("|").join("");
            a = a.split("&").join("");
            a = a.split("'").join("");
            a = a.split("#").join("");
    ...
    <script language="javascript"> function processAcorCookie() { //reading and splitting the whole cookie if (document.cookie && document.cookie !=""){ var whole_cookie = unescape(document.cookie); var each_cookie = whole_cookie.split(";"); //sorting loop for (i = 0; i < each_cookie.length; i++){ if (each_cookie[i].indexOf("ACOR=") > -1){ var acorCookie = each_cookie[i].split("{")[1]; acorCookie = acorCookie.substring(0, acorCookie.length-1); return acorCookie.split(","); } }//ends FOR } return null; }//ends process_cookie() function function getAcorData(dataArray, name){ if(dataArray && dataArray.length > 0){ for(i = 0; i < dataArray.length; i++) { if(dataArray[i].indexOf(name)>=0){ return dataArray[i].substring(dataArray[i].indexOf("=")+1); } } } } </script>
    <script language="javaScript" type="text/javascript"> var site = "modernmedicine"; </script>
    <script language="javaScript" type="text/javascript"
            src="http://www.modernmedicine.com/modernmedicine/sitewide/js/accipiterHead.js"></script>
    <script language="javaScript" type="text/javascript"
            src="http://www.modernmedicine.com/modernmedicine/sitewide/js/acorCookieData.js"></script>
    <script language="javaScript" type="text/javascript"
            src="http://www.modernmedicine.com/modernmedicine/sitewide/js/onload.js"></script>
    <script language="javaScript" type="text/javascript"
            src="http://www.modernmedicine.com/modernmedicine/sitewide/js/renderAds.js"></script>
    <script language="javaScript" type="text/javascript"> var pageName = escape("RealCME");
        var mlcTextString = escape("RealCME");
        document.write('<script type="text/javascript" src="http://www.modernmedicine.com/modernmedicine/sitewide/components/hitBox.jsp?title=' + pageName + '&mlc=' + mlcTextString + '"><\/script>'); </script>
</head>
    ...
    <div id="page-inner">
        <div id="header">
            <div id="header-inner" class="clear-block">
                <div id="logo-title">
                    <div id="logo"><a href="http://modernmedicine.realcme.com/" title="Modern Medicine" rel="home"><img
                                    src="/cms/sites/all/themes/zen/modernmedicinetheme/img/logo.gif" alt=Modern Medicine"
                            id="logo-image" /></a></div>
                </div> <!-- /#logo-title --> </div>
                        ...
                        <div id="content-area">
                                            ...
                                            <div class="node-inner">
                                                <div class="rcmcontent">
                                                    <div class="related-patient-bg"
                                                        ...
                                                        <img src="/cms/../cmsdata/course_icons/icon_2.jpg"
                                                             alt="Accelmed-APw-DP"
                                                    ...
                                                    <div class="activity-subject">
                                                        <div class="activity-title activity-title-display"><span
                                                                    class="promo-link"><a id="lt-228821"
                                                                                          href="/cms/node/228821">Weighing the Net Clinical Benefit of Oral Antiplatelet Agents: A...</a></span>
                                                        </div>
                                                    ...
                                                    <div class="activity-info">Weighing the Net Clinical Benefit of Oral
                                                        Antiplatelet Agents: A Clinical Case Discussion and Current
                                                        Guidelines
                                                    </div>
                                                    ...
                                                    <div class="next-steps-related">
                                                        ...
                                                        <div class="proceed-activity"><span class="promo-link"><a
                                                                        id="lp-228821" href="/cms/node/228821">Proceed To Activity</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="node">
                                            <div class="node-inner">
                                                <div class="rcmcontent">
                                                    <div class="related-patient-bg"
                                                         style="background-image: url(/cms/sites/all/modules/custom/cmecoursepromotion/img/related-patient-bg.gif); ">
                                                        <img src="/cms/../cmsdata/course_icons/icon_hillary_0.gif"
                                                             alt="hillary"
                                                             style="width: 43px; height: 43px; border: 0; margin: 0">
                                                    </div>
                                                    <div class="activity-subject">
                                                        <div class="activity-title activity-title-display"><span
                                                                    class="promo-link"><a id="lt-226858"
                                                                                          href="/cms/node/226858">Hillary Visit 1: A recently retired woman complaining of palpitations...</a></span>
                                                        </div>
                                                        <div class="certified-icon"
                                                             style="background-image: url(/cms/sites/all/modules/custom/cmecoursepromotion/img/CME-certified.gif); "></div>
                                                        <div class="certified-text">Cardiology</div>
                                                    </div>
                                                    <div class="activity-info">"I&#39;ve been feeling some palpitations,
                                                        and feel tired." "
                                                    </div>
                                                    <div style="clear: both;"></div>
                                                    <div class="next-steps-related">
                                                        ...
                                                        <div class="proceed-activity"><span class="promo-link"><a
                                                                        id="lp-226858" href="/cms/node/226858">Proceed To Activity</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class='listing-featured'>
                                <div class='listing-tabs'>
                                    <form action="http://modernmedicine.realcme.net/cms/listingall"
                                ...
                                <div class='listing-featured-table'>
                                    <table id="listing-featured" align="center">
                                        ...
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://modernmedicine.realcme.net/cms/../cmsdata/course_icons/icon_2.jpg"
                                                        alt="icon.jpg" title="icon.jpg" width="42" height="42"/></td>
                                            <td valign="top" style="font-weight: normal;" class="view-field-node-title">
                                                <a href="/cms/node/228821?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=feature&amp;utm_campaign=">Weighing
                                                    the Net Clinical Benefit of Oral Antiplatelet Agents: A Clinical
                                                    Case Discussion and Current Guidelines</a><br/>Cardiology
                                            </td>
                                            ...
                                            <td class="view-field-term-node-3-name">Acute Coronary Syndrome,
                                            ...
                                            <td class="view-field-content-type-activity-group-field-group-name-value">
                                                Hot Topics in the Management of Patients with Acute Coronary Syndromes:
                                                A Clinical Case...
                                            </td>
                                        ...
                                        <tr class="even">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://modernmedicine.realcme.net/cms/../cmsdata/course_icons/icon_hillary_0.gif"
                                                        alt="icon_hillary.gif" title="icon_hillary.gif" width="43"
                                                        height="43"/></td>
                                            <td valign="top" style="font-weight: normal;" class="view-field-node-title">
                                                <a href="/cms/node/226858?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=feature&amp;utm_campaign=">Hillary
                                                    Visit 1: A recently retired woman complaining of palpitations and
                                                    fatigue presents with atrial fibrillation</a><br/>Cardiology
                                            </td>
                                            <td valign="top" style="font-weight: normal;text-align: center"
                                                class="view-field-node-data-field-all-credits-field-all-credits-value">
                                                0.75&nbsp;AMA<br/></td>
                                            ...
                                            <td class="view-field-node-data-field-patient-statement-field-patient-statement-value">
                                                "I&#39;ve been feeling some palpitations, and feel tired."
                                            </td>
                                            <td class="view-field-node-data-field-course-desc-field-course-desc-value"></td>
                                            <td class="view-field-node-data-field-faculty-field-faculty-value">William
                                                M. Miles, MD
                                            </td>
                                            <td class="view-field-term-node-3-name">Coronary Artery Disease,
                                            ...
                                            <td class="view-field-content-type-activity-group-field-group-name-value">
                                                Contemporary, Challenging, and Controversial Issues in Atrial
                                        ...
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://modernmedicine.realcme.net/cms/../cmsdata/course_icons/duke_logo_0.jpg"
                                                        alt="duke_logo.jpg" title="duke_logo.jpg" width="42"
                                                        height="43"/></td>
                                            <td valign="top" style="font-weight: normal;" class="view-field-node-title">
                                                <a href="/cms/node/107835?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=feature&amp;utm_campaign=">Duke
                                            ...
                                            <td class="view-field-node-data-field-patient-statement-field-patient-statement-value"></td>
                                            <td class="view-field-node-data-field-course-desc-field-course-desc-value"></td>
                                            <td class="view-field-node-data-field-faculty-field-faculty-value">Joyce
                                                Copeland, MD
                                            </td>
                                            <td class="view-field-term-node-3-name">Family Medicine, Geriatric Medicine,
                                                Gynecology
                                            </td>
                                            <td class="view-field-node-data-field-activity-group-field-activity-group-nid">
                                                94760
                                            ...
                                            <td class="view-field-content-type-activity-group-field-group-name-value">
                                                Diagnosing and Managing Overactive Bladder in Primary Care
                                            </td>
                                            <td class="related-activities"></td>
                                        </tr>
                                        <tr class="even">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://modernmedicine.realcme.net/cms/../cmsdata/course_icons/icon_kelley.gif"
                                                        alt="icon_kelley.gif" title="icon_kelley.gif" width="43"
                                                        height="43"/></td>
                                            <td valign="top" style="font-weight: normal;" class="view-field-node-title">
                                                <a href="/cms/node/155827?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=feature&amp;utm_campaign=">Kelley
                                                    Visit 1: A 34-year-old female diagnosed with rheumatoid arthritis
                                                    four months ago</a><br/>Rheumatology
                                            </td>
                                            <td valign="top" style="font-weight: normal;text-align: center"
                                                class="view-field-node-data-field-all-credits-field-all-credits-value">
                                            ...
                                            <td class="view-field-node-data-field-patient-statement-field-patient-statement-value">
                                                "I&#39;m feeling a bit better, but my hands and feet are still sore and
                                                I&#39;m tired all the time."
                                            </td>
                                            <td class="view-field-node-data-field-course-desc-field-course-desc-value"></td>
                                            <td class="view-field-node-data-field-faculty-field-faculty-value">Jonathan
                                                Samuels, MD
                                            </td>
                                            <td class="view-field-term-node-3-name">Arthritis; Early Rheumatoid
                                                Arthritis; Joint Erosion; Joint Pain; Rheumatoid Arthritis
                                            </td>
                                            <td class="view-field-node-data-field-activity-group-field-activity-group-nid">
                                                155790
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td valign="top" style="font-weight: normal;"
                                                class="view-field-node-data-field-icon-field-icon-fid"><img
                                                        src="http://modernmedicine.realcme.net/cms/../cmsdata/course_icons/LayoutCover_1c.png"
                                                        alt="LayoutCover_1c.png" title="LayoutCover_1c.png" width="42"
                                                        height="42"/></td>
                                            <td valign="top" style="font-weight: normal;" class="view-field-node-title">
                                                <a href="/cms/node/200758?utm_source=activitylist&amp;utm_medium=web&amp;utm_content=feature&amp;utm_campaign=">An
                                                    Evidence-based Approach to the Diagnosis and Treatment of COPD:
                                                    Improving Patient Care</a><br/>Pulmonary Disease
                                            </td>
                                            <td valign="top" style="font-weight: normal;text-align: center"
                                                class="view-field-node-data-field-all-credits-field-all-credits-value">
                                                0.75&nbsp;AMA<br/></td>
                                            ...
                                            <td class="view-field-term-node-1-name">Pulmonary Disease</td>
                                            <td class="view-field-node-data-field-active-begin-date-field-active-begin-date-value">
                                                30-Dec-11
                                            </td>
                                            <td class="view-field-node-data-field-patient-statement-field-patient-statement-value"></td>
                                            <td class="view-field-node-data-field-course-desc-field-course-desc-value"></td>
                                            <td class="view-field-node-data-field-faculty-field-faculty-value">Amir
                                                Sharafkhaneh, MD, PhD
                                            </td>
                                            <td class="view-field-term-node-3-name">Bronchodilators, COPD, Respiratory,
                                                Spirometry
                                            </td>
                                            <td class="view-field-node-data-field-activity-group-field-activity-group-nid">
                                                200760
                                            ...
                                            <td class="view-field-content-type-activity-group-field-group-name-value">
                                                Diagnosis and Treatment of COPD - Improving Patient Care
                                            </td>
                                            <td class="related-activities"></td>
                                        </tr>
                                        </tbody>
                    ...
                    <div id="sidebar-right-inner">
                        <div id="altcontainer2">
                            <div id="companionlogo"><img
                                        src="/cms/sites/all/themes/zen/modernmedicinetheme/img/logo-companion.gif"
        ...
        <div id="footer">
            <div id="footer-inner">
                <div id="footer-message">
                    <center>
                        <!-- <small> Copyright &copy; RealCME, Inc. 2008-2017. All Rights Reserved. <a href="/cms/privacypolicy">Privacy Policy</a>&nbsp; <a href="/cms/termsofservice">Terms of Service</a>&nbsp; <a href="/cms/support-center">Support</a></small><br /><br /> --><img
                                src="/cms/sites/all/themes/zen/modernmedicinetheme/img/footerlogo.png" alt=""
                                class="center"/></center>
                </div>
            </div>
