...
<head>
    ...
    <style>
        ...
        /* BOF #8378, remove template sections
        #page-main {
            background-image: url("<?php print $img_path ?>/img/header-bg.png");
        ...
        EOF #8378*/
        #page-main { background:#FFFFFF; border: 1px solid #fff; }
        ...
        <div id="header"><div id="header-inner" class="clear-block">
                ...
                <div class="navbar pull-right">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <?php if ( !$user->uid ) { ?>
                            <!-- #8378, remove template sections -->
                            <?php /*<li><a href="<?php echo base_path();?>user">LOGIN</a></li>*/ ?>
                            <li><a href="<?php echo base_path();?>user?destination=listingall">LOGIN / REGISTER</a></li>
                        <?php } ?>
                        <?php if ( $user->uid ) { ?>
...
<?php /* BOF #8378, remove template sections
                                ...
                                <div style="display: table;width: 960px; font-family: 'Helvetica Neue'; font-size: 14pt;">
                                    ...
                                    <div style="display: table-cell; width:635px; height: 270px; padding: 10px 10px 0px 10px;">
                                        ...
                                        <p style="font-size: 20pt; font-family: 'Montserrat', sans-serif; color: #056696; padding-bottom: 0px;">Welcome to Real<strong>CME</strong><br />Health Professional.</p>

                                        <div style="background: #056696; color: white; padding:10px; margin-bottom: 0px; border-radius: 3px; font-weight: bold; margin-right: 20px;"> Are you registered with EpocratesCME?</div>
                                        <p style="padding-top: 5px; padding-left: 50px;"><a href="/cms/user/password/">UPDATE YOUR ACCOUNT NOW</a><br />
                                            Get immediate access to all your certificates<br />and all CME past activities.</p>

                                        <div style="background: #056696; color: white; padding:10px; margin-bottom: 0px; border-radius: 3px; font-weight: bold; margin-right: 20px;">New to RealCME Health Professional?</div>
                                        <p style="padding-top: 5px; padding-left: 50px;"><a href="/cms/user/register/">CREATE A NEW ACCOUNT</a></p>
...
EOF #8378 */ ?>
                            ...
                            <?php } else { ?>
                                ...
                                if ($user->uid &&
                                    ...
                                    <div style="display: table;width: 770px; font-family: 'Helvetica Neue'; font-size: 14pt;">
                                        ...
                                        <!-- #8402, comment:4; changed display property from 'table-cell' to 'none' -->
                                        <div style="display:none; width:635px; height: 125px; padding: 10px 10px 0px 10px;">
                            ...
                            <?php if ( isset($get_uri[3]) && $get_uri[3] != '' && $get_uri[3] == 'password' ) { ?>
                                ...
                                <?php echo $html_text; ?>
                                If you are an EpocratesCME registered user and you're visiting RealCME Health Professional for the first time, welcome! Your account is available to you as always. Just use the same email address you used on EpocratesCME and request a new password for security purposes.<br /><br />
                        ...
                        <!-- oauth block -->
	                        <?php if ( !isset($get_uri[3])  && $get_uri[2] == 'user' ) { ?>
								<a class="oauth realcme linkedin" style="" 
									href="http://hp.realcme.com/cms/oauth/linkedin/login/hp">
										<img src="/cms/sites/all/modules/custom/cmeoauth/img/linkedin.png">
								</a>
								<a class="oauth realcme facebook" style="" 
									href="http://hp.realcme.com/cms/oauth/facebook/login/hp">
										<img src="/cms/sites/all/modules/custom/cmeoauth/img/facebook.png">
								</a>
							<?php } ?>
						<!-- end of oauth block -->
...
<script>
    ...
    <?php } */?>
        ...
        // #8402, comment:4
        $('#related-activities #related-activities-title').css('margin-top', 0);
        $('.node').find('.next-steps-related').css('float', 'left');
        $('.node').find('.next-steps-related div:empty').each(function(){ $(this).hide(); });
    });
</script>
<?php if (!$user->uid &&
    (
