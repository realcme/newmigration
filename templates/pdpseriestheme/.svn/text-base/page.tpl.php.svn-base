...
<body class="<?php print $body_classes; ?>">
		...
		<div id="mainNavWrapper">
			<div id="mainNavLogoWrapper">
				<div id="logoWrapper" class="grid_2">
					<a href="http://pdpseries.com/"> <img style="max-height: 78px;"
						src="<?php print $img_path ?>/img/pdp_logo.png"
						alt="pdpseries.com" class="pngfix"></img></a>
				</div>
				<nav id="mainNav" style="display:none;">
				<ul class="grid_9 regNav">
					<li class="firstNavItem"><a
						href="http://pdpseries.com/#webinar"
						class="topNavItem">On Demand Webinar</a>
						</li>
					<li><a
						href="http://pdpseries.com/#earn"
						class="topNavItem">CME MONOGRAPH</a>
						</li>
					<li><a
						href="http://pdpseries.com/#library"
						class="topNavItem">CME VIDEO CASE LIBRARY</a>
						</li>
	...
	<div id="page">
        ...
        <div id="logo-title">
            ...
            title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/logo.gif" 
            alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
        </div> -->
					<!-- /#logo-title -->
 ...
 -->
			...
			<div id="footer">
				<div id="footer-inner">
					...
					<div id="footer-message">
						<center>
       <?php print $footer_message; ?><img
							src="<?php print $img_path ?>/img/footerlogo.png" alt=""
							class="center" /> </center>
					</div>
	...
	<div class="rawHTMLAsset">
		<p style="text-align: center;">© <?=date("Y");?> MedEdicus LLC 124</p>
