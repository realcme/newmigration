  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
					...
					<div id="logo-title">
						...
						<div style="clear:both;font-size:48px;font-family:Times New Roman;color:black">
							<span>The PAH Virtual Clinic.</span>
						</div>
						<div style="clear:both;font-size:28px;font-family:Times New Roman;color:#35C0E2;font-weight:bold">
							<span>A structured education program specifically for healthcare
								providers who manage Pulmonary Artery Hypertension.</span>
						</div>
					</div>
					<!-- /#logo-title -->
...
<div id="fundstrip">		
		<div>
				...
				<p>This activity is supported by an educational grant from United Therapeutics Europe Limited.</p><img alt="United Therapeutics." src="<?php print $img_path ?>/img//footer-logo-ut.png">
