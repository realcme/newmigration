	...
	<div id="gt-frame-footer">
		<div id="gt-frame-bottom">
		  <div id="gt-frame-bottom-left">
		    <div style='float: relative; padding-right: 64px' id="gt-frame-bottom-right">
          <input style="display:none; margin-top: 12px;" id="gt-save" name="op" value="Submit" class="form-submit" type="button" />     
