...
<head>
  ...
  <?php if ($_GET['ckeditor']): ?>
    <script type="text/javascript" src="<?php print base_path() . drupal_get_path('module', 'cmeauthor') ?>/ckeditor/ckeditor.js"></script>
	  <script type="text/javascript" src="<?php print base_path() . drupal_get_path('module', 'cmeauthor') ?>/ckeditor/config.js"></script>
   <?php endif; ?>
