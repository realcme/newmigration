...
<head>
  ...
  <?php print $head; ?>
  <?php print $styles; ?>
  <link rel="stylesheet" href="<?php print $base_path . $subtheme_directory; ?>/css/draftcourse.css" type="text/css">
  <link rel="stylesheet" href="<?php print $base_path . $subtheme_directory; ?>/css/draftcourse_nav.css" type="text/css">
  <link rel="stylesheet" href="<?php print $base_path . $subtheme_directory; ?>/css/draftcourse_accordion.css" type="text/css">
  <!--[if IE]>
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $navbar) { print ' with-navbar'; } ?>">
      ...
      <div id="content"><div id="content-inner">
        ...
        <div id="content-area">
          <div id="draftcourse">
            THIS IS A DRAFT COURSE - DATA WILL BE CLEARED ON A REGULAR BASIS
          </div>
      ...
      <?php endif; ?>
        ...
        <div id="sidebar-right"><div id="sidebar-right-inner">
          ...
          <div id="altcontainer2">
            <div id="disabled-companion">
              <img src="<?php print $img_path ?>/img/draftcourse/disabled-companion.png" alt="CME Companion" class="" />
            </div>
          </div>
      <!--  altcontainer2 -->
