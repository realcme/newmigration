...
<body class="<?php print $body_classes; ?>">
  	<div class="upennheader" id="site-header">
        ...
        <a href="/" id="upennlogo" rel="home" title="University of Pennsylvania homepage"><img src="<?php print $img_path ?>/img/logo-cme-perelman.png" alt="Penn: University of Pennsylvania" /></a>
  	  </div>    
    </div>
