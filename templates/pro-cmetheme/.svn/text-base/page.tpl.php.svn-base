...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
            ...
            <div id="logo"><a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/new_images/procme-logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
...
<p>&copy;Pro-CME Copyright <?php echo date("Y"); ?></p> 
<ul class="inline"><li><a href="http://pro-c.me/privacy" target="_blank">Privacy Policy</a></li> 
      <li>|</li> 
