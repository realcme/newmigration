...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
            ...
            <div id="logo"><a href="http://dkbmed.com/smartrealcme" rel="home"><img src="<?php print $img_path ?>/img/smart_logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
...
<div id="footer">
  <div id="footerLogo">
    <img src="<?php print $img_path ?>/img/smart_footer_logo.png" alt="dkb">
    <img src="<?php print $img_path ?>/img/smart_pim_footer_logo.png" akt="pim">
  </div>
<div id="copyright">
  <a href="http://dkbmed.com/#privacy" target_"blank">privacy</a> |
	&copy; <?=date("Y");?> dkbmed<br />
</div>
