...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
            ...
            <div id="logo"><a href="http://www.crohnscolitisfoundation.org" rel="home"><img src="<?php print $img_path ?>/img/ccf_logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
...
<div id="footer">
<div id="copyright">
	&copy; <?=date("Y");?> Crohn's & Colitis Foundation <br />
	<a href="http://www.crohnscolitisfoundation.org/" target="_blank">Visit our site</a>
</div>
