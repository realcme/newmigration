  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
        <div id="cmecorner-title">
            <div id="logo"><a href="http://www.cmecorner.com" title="<?php print t('cmecorner'); ?>" rel="home"><img src="<?php print $img_path ?>/img/cmecorner-logo.jpg" alt="<?php print t('cmecorner'); ?>" id="logo-image" /></a></div>
        </div> 
			<!-- /#logo-title -->
