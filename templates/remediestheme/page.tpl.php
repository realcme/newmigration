...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
        <div id="logo-title">
            <div id="logo"><a href="http://www.remediescme.com" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/remedies_logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
            <div id="rems"><a href="<?php print base_path()?>">home</a></div>
        </div> <!-- /#logo-title -->
 ...
 -->
    ...
    <div id="footer"><div id="footer-inner">
      ...
      <div id="footer-message">
       ...
       <br/>
       <small>
       Copyright &copy; <?=date("Y");?> Applied Clinical education unless otherwise noted. CMEZone.com is part of McMahon Group.</br/>
