...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page">
     <div id="logo-title">
        <div id="logo">
	    <a href="<?php print $base_path."../"; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/patientcoach-logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a>
<a href="<?php print $base_path."../"; ?>" title="AACME"><img src="<?php print $img_path ?>/img/aacme_logo.png" style="width: 120px;" alt="AACME" id="aacme-image" /></a>
	</div>
     </div>
    <div class="nav">    
      <?php if ($header): ?>
