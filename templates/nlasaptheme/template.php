<?php
// $Id: template.php,v 1.1 2009-05-20 18:09:55 valerie Exp $
...
drupal_set_html_head('<meta name="viewport" content="width=device-width, initial-scale=1" />');
drupal_set_html_head('<meta name="apple-mobile-web-app-capable" content="yes" />');
...
drupal_add_css(path_to_subtheme() .'/css/tabs.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/layout.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/style.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/block.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/frontmatter.css', 'theme', 'all');

global $user;
if (!($user && $user->uid == 1)) {
	drupal_add_css(path_to_subtheme() .'/css/nlasap.css', 'theme', 'all');
	drupal_add_css(path_to_subtheme() .'/css/mobile.css', 'theme', 'all');
}
...
if (!($user && $user->uid == 1)) {
	drupal_add_js(path_to_subtheme().'/js/nlasap.js');
	drupal_add_js(path_to_subtheme().'/js/mobile.js');
}
