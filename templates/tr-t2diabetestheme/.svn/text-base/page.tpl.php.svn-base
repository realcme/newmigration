...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
        ...
        <div id="logo-title">
            <div id="logo"><a href="<?php print $base_path."../"; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/ada_header.jpg" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
        </div> <!-- /#logo-title -->
...
<map name="Map" id="Map"><area shape="rect" coords="66,11,281,75" href="http://www.pimed.com/" target="_blank" />
...
<area shape="rect" coords="758,18,923,64" href="http://thomsonreuters.com/products_services/healthcare/ " target="_blank" />
<area shape="rect" coords="276,72,283,73" href="#" /></map>
