...
<body class="<?php print $body_classes; ?>">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
        ...
        <div id="logo-title">
            <div id="brandlogo"><a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/hcplive_logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
        </div> <!-- /#logo-title -->
