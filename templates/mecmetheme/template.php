<?php
// $Id: template.php,v 1.2 2010-02-18 15:14:36 psantini Exp $
...
drupal_add_css(path_to_subtheme() .'/mecme.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/mecme/mecme.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/mecme/ddsmoothmenu.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/mecme/ddsmoothmenu-v.css', 'theme', 'all');
...
drupal_add_js(path_to_subtheme().'/js/number_slideshow.js');
drupal_add_js(path_to_subtheme().'/js/custom.js');
drupal_add_js(path_to_subtheme().'/js/ddsmoothmenu.js');
drupal_add_js(path_to_subtheme().'/js/kriesi.js');
