<?php
// $Id: template.php,v 1.20 2009-12-14 14:31:30 psantini Exp $
...
drupal_add_css(path_to_subtheme() .'/css/new_layout.css', 'theme', 'all');
...
// BOF Client custom stylesheets and scripts
drupal_add_css(path_to_subtheme() .'/css/axismeded.css', 'theme', 'all');
drupal_add_js(path_to_subtheme() .'/js/axismeded.js');
// EOF custom
