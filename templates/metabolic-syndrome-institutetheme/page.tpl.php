...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
        ...
        <div id="logo-title">
            <div id="logo">
              <a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/msi-logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a>
              <div style="clear: both;"></div>
              <div class="msi"><a href="http://www.metabolic-syndrome-institute.org/">Metabolic Syndrome Institute</a></div>
            </div>
        </div> <!-- /#logo-title -->
