...
function resize_forumframe() {
	...
	if (x) {
		height = x.contentWindow.document.body.offsetHeight || x.contentWindow.document.body.scrollHeight || x.contentDocument.height;
/*		if (browser == 'Microsoft Internet Explorer') {
        ...
        } else if (navigator.userAgent.indexOf('Firefox/6') >=0) {
            height=x.contentWindow.document.body.offsetHeight;
		} else {
