...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="masthead" class="clearfix">
		<div class="oncologylogo">
			<a href="http://www.oncologystat.com/index.html"><span class="oov">OncologyStat<sup>&reg;</sup> One Source, Many Resources. By Elsevier</span></a>
		</div>

    </div>
    <div id="blue-bar">
      <div style="float: left">The Oncology Virtual Practice</div>  <div class="powered_by" style="float:right">Powered by RealCME</div>
    </div>
      ...
      <div id="footer-message">
       ...
       <?php print $footer_message; ?><img src="<?php print $img_path ?>/img/footerlogo.png" alt="" class="center" />
			...
			<div id="user">
				<ul>
					<li class="cme-home">
						<a href="http://www.oncologystat.com/cme/index.html">CME Home</a>
					</li>
