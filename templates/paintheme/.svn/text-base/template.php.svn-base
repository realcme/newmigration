<?php
// $Id: template.php,v 1.2 2009-09-24 12:55:18 csouthern Exp $
...
drupal_add_css(path_to_subtheme() .'/css/pain_layout.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/ddlevelsmenu-topbar.css', 'theme', 'all');
