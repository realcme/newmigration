<?php
// $Id: template.php,v 1.2 2009-06-26 15:28:03 csouthern Exp $
...
drupal_add_css(path_to_subtheme() .'/css/general.css', 'theme', 'all');
...
// Javascript
drupal_add_js(path_to_subtheme() . '/javascript/JScripts.js');
