  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
        ...
        <div id="logo-title" style="clear:both">
            <div id="logo"><a href="<?php print $base_path."../"; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/axis_pim_header.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
        </div>
        <?php if ($header): ?>
        ...
        <div id="axismedednavmain">
            <div id="axismedednavmainwrapper">
              <nav>
                <ul class="grid_9">
                    <li>
                      <a href="http://axismeded.com/visitor/axis-medical-education-continuing-education-for-physicians-nurses-and-other-health-professionals?en,0,,758" class="topNavItem ">HOME</a>
                    </li>
                    <li>
                      <a href="" class="topNavItem ">ABOUT US</a>
                        <div style="display: none;" class="subnavdropdown">
                                    <div class="grid_2 dropdownCallout noBorder">
                                        <ul>
                                                    <li><a href="http://axismeded.com/visitor/axis-who-we-are?en,0,,758" title="">Who We Are</a></li>
                                                    <li><a href="http://axismeded.com/visitor/axis-advocacy?en,0,,758" title="">Advocacy</a></li>
                                                    <li><a href="http://axismeded.com/visitor/axis-about-us?en,0,,758" title="">About Us</a></li>
                                        </ul>
                                    </div>
