...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
            ...
            <div id="logo"><a href="http://medreviews.com/" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/new_images/logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
...
<ul id="top_nav_links">
    ...
    <div id="page-main" style="border-top: 53px #21376e solid;"><div id="main-inner" class="clear-block<?php
...
<!-- 
 ...
 -->
      ...
      <?php endif; ?>
        ...
        <div id="sidebar-right" style="min-width: 0;"><div id="sidebar-right-inner">
...
<div style="background-color: #2d2d2d; border-top: 40px #313131 solid; padding:3em 20em; margin:0 -24em;">
	<div style="margin: auto; color: #8F8F8F;">
		Copyright © 2017 MedReviews, LLC. All rights reserved
	</div>
</div>
