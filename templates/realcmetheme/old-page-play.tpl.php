...
<head>
  <title><?php print $head_title; ?></title>
  	<?php print $viewport; ?>
		...
		<link rel="apple-touch-icon" href="<?php print $img_path; ?>/img/touch_icon_small.png" />
		<link rel="apple-touch-icon" href="<?php print $img_path; ?>/img/touch_icon_medium.png" sizes="72x72" />
		<link rel="apple-touch-icon" href="<?php print $img_path; ?>/img/touch_icon_big.png" sizes="114x114" />
  <?php print $head; ?>
  <?php print $styles; ?>
  <!--[if IE]>
...
<div id="footer">
<div id="copyright">
	&copy; <?=date("Y");?> RealCME. All rights reserved.
</div>
...
<ul>
    ...
    <li><a href="mailto:support@realcme.com">Support</a></li>
