...
<?php  
  if ($user->uid && $proceed_conditions['can_proceed']) {
      global $brand;
...
?>
				<div style="padding-bottom:20px;padding-top:10px;float:right;">
					...
					<div style="float:left;padding-top:7px"><a href="<?php print $proceed_url?>">Proceed to Stage A</a></div>
			  </div>
<?php       
  } 
?>
...
?>
<?php  
if ($user->uid && $proceed_conditions['show_enrollment']) {
        // Check if the learner can enroll
?>      
     <div id="enroll-form"><?php print drupal_get_form('cmepicme_enrollmentform', $nid);?></div>
<?php         
} 
?>
