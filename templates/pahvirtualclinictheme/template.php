...
drupal_set_html_head('<link rel="shortcut icon" href="'. drupal_get_path('module', 'healthcourse').'/favicon.ico' .'" type="image/x-icon" />');
...
drupal_add_css(path_to_subtheme() .'/css/healthblock.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/frontmatter.css', 'theme', 'all');
drupal_add_css(path_to_subtheme() .'/css/pahvirtualclinic.css', 'theme', 'all');
...
// Javascript
drupal_add_js(drupal_get_path('module', 'healthcourse').'/js/allscripts.js?v=1');
