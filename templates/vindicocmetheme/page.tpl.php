...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
    ...
    <div id="header"><div id="header-inner" class="clear-block">
            ...
            <div id="logo"><a href="<?php print $base_path; ?>" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $img_path ?>/img/new_images/vindico-logo.png" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
...
<div id="nav-menu">
            ...
            <ul>
                <li class="first"><a href="http://www.vindicocme.com/companyoverview" id="nav-companyoverview" target="_blank">Company Overview</a></li>
                <li><a href="http://www.vindicocme.com/capabilities" id="nav-capabilities" target="_blank">Capabilities</a></li>
                <li><a href="http://www.vindicocme.com/contactus" id="nav-contactus" target="_blank">Contact Us</a></li>
                <li><a href="http://www.vindicocme.com/educationaltools" id="nav-educationaltools" target="_blank">Educational Tools</a></li>
            </ul>

          </div>
<!--EOF custom navigation-->
...
<!-- 
 ...
 -->
    ...
    <!--BOF client footer -->
    <div id="vindico-footer">
        <p>Vindico Medical Education<br />6900 Grove Road, Building 100 | Thorofare, NJ 08086 | 888.960.0256 | 856.994.9400 (in NJ)</p>
        <p class="footer"><br />Copyright &copy;2017 Vindico Medical Education | <a href="http://www.vindicocme.com/companyoverview/privacypolicy" target="_blank">Privacy Policy</a></p>
    </div>
    <!--EOF footer -->
