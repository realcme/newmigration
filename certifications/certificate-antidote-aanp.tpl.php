    ...
    <tr><td>
      <table style="border: 2px solid #FDB141; width:100%;border-top: none;">
        ...
        <tr>
          ...
          <div style="width: 95%; font-size:9pt; text-align:justify;"><strong>AANP:</strong> This program is approved for  
          <?php print $certificate['aanp']?> contact hour(s) of continuing education by the American Association of Nurse Practitioners (AANP).  Program ID <?php print $certificate['@aanp_pid']?>. This program was planned in accordance with AANP CE Standards and Policies and AANP Commercial Support Standards.
          </div></td>
        </tr>          
        <tr>
