...
$date = $certificate['@livedate'] ? $certificate['@livedate'] : $certificate['dateearned'];
?>
        ...
        <table style="border: 1px solid black;">
          ...
          <tr>
            ...
            <span style="font-weight:bold;"><?php print $certificate['course_title'] ?></span>
              on  <?php print $date ?>  at Cedars-Sinai Medical Center in Los&nbsp;Angeles,&nbsp;CA.
              <br /><br /> This activity was designated for <?php print $certificate['amapracat1'].$pratext ?>.</td>
          </tr>          
          <tr>
