...
<div style="font-size:11.0pt;font-family:Arial, Times, serif;color: #000000;margin:0px; padding:0;">
    ...
    <table style="width: 100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr><td style="padding-top: 10px;" valign="top" align="center"><img src="<?php echo $img_url;?>/hme-logo.png"></img></td></tr>
                            ...
                            <tr><td style="font-size:20.0pt; font-weight: bold; padding-top: 10px; padding-bottom: 20px;" align="center">CERTIFICATE OF CREDIT</td></tr>
                            ...
                            <tr><td style="font-size:11.0pt;" align="center">and is awarded <?php print $certificate['amapracat1'].$pratext ?></td></tr>
