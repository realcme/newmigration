...
<table width="600px" style="border: 2px solid black;">
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:15px"><span style='font-size: 14pt;font-weight: bold;'>CONTINUING EDUCATION</span></td>
          </tr>          
          <tr>
            <td align="center" colspan="2" style="padding-top:15px"><span style='font-size: 14pt;font-weight: bold;'><?php print $pratext?></span></td>
          </tr>          
          <tr>
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:20px"><span style='font-size:14.0pt;font-weight: bold;'><?php print $certificate['firstname'] ?> <?php print $certificate['lastname'] ?><?php print $occupation ?></span>
            </td>
          </tr>          
          <tr>
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:15px;padding-bottom:25px">on  <?php print $certificate['dateearned'] ?>  <br /><br />
