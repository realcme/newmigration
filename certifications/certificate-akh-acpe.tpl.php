...
$akh_release_date = $certificate['@akh_release_date'] ? $certificate['@akh_release_date'] : $certificate['begin_date'];
$akh_release_date = strftime("%m/%d/%Y", strtotime($akh_release_date));
$akh_expiration_date = $certificate['@akh_expiration_date'] ? $certificate['@akh_expiration_date'] : $certificate['expiration_date'];
$akh_expiration_date = strftime("%m/%d/%Y", strtotime($akh_expiration_date));
...
$pluralapproved  = ($certificate['acpe'] > 1) ? "s" : '';
