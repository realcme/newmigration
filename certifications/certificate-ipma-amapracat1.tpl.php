...
<table width="600px">
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:5px"><span style='font-size:14.0pt;'>CME Certificate</span></td>
          </tr>          
          <tr>
          ...
          <tr>
            <td align="left" colspan="2" style="padding-top:10px">IPMA certifies that the person listed above has participated in the education activity titled <span style="font-weight: bold"><?php print $certificate['course_title'] ?></span> and is awarded <?php print $certificate['creditearned'].$pratext?>.</td>
          </tr>          
          <tr>
