...
$id = $certificate['@uan'];
if ($id) $id = "Universal Activity Number(s): $id";
...
<div style="font-size:11.0pt;font-family:arial, Times New Roman, Times, serif;color: #000000;clear: both;width: 620px;margin: auto;padding: 0px;">
    ...
    <table style="border: 2px solid black; width: 620px;">
      ...
      <tr>
        <td align="center" colspan="2" style="padding-top:6px;font-weight:bold;font-style:italic">
        	<?php print $certificate['firstname'] ?> <?php print $certificate['lastname'] ?>
        </td>
      </tr>          
      <tr>
        <td align="center" colspan="2" style="padding-top:10px">The NLA certifies that the individual listed has participated in the Activity titled:</td>
      </tr>          
      <tr>
        <td align="center" colspan="2" style="padding-top:10px"><span style='font-style:italic;'><?php print $certificate['course_title'] ?></span></td>
      </tr>    
      <tr>
        <td align="center" colspan="2" style="padding-top:15px;font-size:10.0pt;"><span style='font-style:italic;'>NLA designates this continuing education 
        activity for a maximum of <?php print $certificate['acpe']?> contact hour(s) (<?php print $CEUapproved?> CEUs) of the Accreditation Council for Pharmacy Education.</span>         
        </td>
      </tr>          
      <tr>
	  ...
	  <tr style="padding-top:25px;">
	  	...
	  	<td style="width:45%;padding-left:20px;padding-top:40px;font-size:10.0pt;vertical-align:top">
	  	        <img src="<?php print $img_url?>lipid_acpe.jpg" style="max-height:60px;"></img>
      ...
      <tr>
        <td align="left" style="width:55%;padding-left:20px;padding-top:10px;font-size:10.0pt;vertical-align:top">
        	Activity Type: <?php print $certificate['@uantype'] ?><br/>
        ...
        In support of improving patient care, The National Lipid Association is jointly accredited by the Accreditation Council 
        for Continuing Medical Education (ACCME), the Accreditation Council for Pharmacy Education (ACPE), and the 
        American Nurses Credentialing Center (ANCC) to provide continuing education for the healthcare team.<br /><br />
        </td>
      </tr>  
      <tr>
      	<td colspan="2" style="width:100%; padding: 0 15px 0 15px;">
      		<div style="border: 1px solid;">
		      	This is not an official statement of credit. To receive your official statement of credit 
		      	you must go to your NABP e-profile to print an individual statement of credit or a transcript. 
