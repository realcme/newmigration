...
$activity_number = $certificate['@number'];
if (!empty($activity_number)) {
...
<table width="520px">
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:5px"><span style='font-size:18.0pt;font-weight: bold'>CERTIFICATE OF PARTICIPATION</span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:10px">on <?php print $date?>.<br/>The activity was designated for <?php print $amountmax.$pratext ?></td>
          </tr>
          <tr>
