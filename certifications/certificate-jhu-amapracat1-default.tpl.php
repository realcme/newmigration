...
<div style="font-size:11.0pt;font-family:Arial, Times, serif;color: #000000;clear: both;margin: auto;width: 600px;padding: 0px;">
  <div style="position: absolute; top: 0px; left:0px; padding: 10px">
    <table style="width: 100%;">
            ...
            <tr>
              <td align="center" colspan="2" style="padding-top:5px"><span style='font-size:14.0pt;'>Certificate of Attendance</span></td>
            </tr>                      
            <tr>
            ...
            <tr>
              <td align="center" colspan="2" style="padding-top:15px">on  <?php print $certificate['dateearned'] ?>.  The activity was designated for <?php print $certificate['amapracat1'].$pratext ?>           
              </td>
            </tr>
            <tr>
