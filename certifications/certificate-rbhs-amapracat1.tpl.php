    ...
    <body>
        <table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
                <tr>
                    ...
                    <td style="vertical-align: top; width: 40%;"><small><span style="font-family: Arial; font-size: 10px"> Center for Continuing and Outreach Education</span><br>
                    ...
                    <td style="vertical-align: top; width: 15%;"><small><span style="font-family: Arial;  font-size: 10px">ccoe.rbhs.rutgers.edu</span><br>
        ...
        <?php echo strftime("%A, %B %d, %Y", strtotime($certificate['dateearned'])); ?> and is awarded <?php echo $certificate['creditearned']; ?>
        <i>AMA PRA Category 1 Credit(s)&trade;</i>.
        <br>
        <br>
