...
$activity = $certificate['@ed'] ? $certificate['@ed'] : "enduring material";
$aacn = $certificate['@aacn'];
$aacnfile = $certificate['@aacn_file'];
if ($aacnfile) {
  $aacnfile = ', '. $aacnfile;
} else {
  $aacnfile = '.';
}
$aapa = $certificate['@aapa'];
$brn = $certificate['@brn'];
//$date = $certificate['@eventdate'] ? $certificate['@eventdate'] : $certificate['dateearned'];
?>
