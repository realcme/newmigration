...
$date_begin = strftime("%B %d, %Y", strtotime($certificate['begin_date']));
...
<table width="620px" style="border: none;padding:5px">
          ...
          <tr>
            ...
            The California Board of Registered Nursing certifies CAFP as a continuing education provider (number 1809).  
            This certificate must be retained for a period of four years after the conclusion of the course.
          ...
          <tr>
            <td align="left" colspan="2" style="padding-top:15px;padding-bottom:15px;">
              <img src="<?php print $img_url?>cafp_signature2.png"></img><br/>
              Shelly B. Rodrigues, CAE<br/>
              Deputy Executive Vice President, California Academy of Family Physicians
            </td>
          </tr>   
          <tr>
