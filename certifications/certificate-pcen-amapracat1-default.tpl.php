...
$plural = floatval($certificate['creditearned']) > 1 ? 's' : ''; 
?>
    ...
    <table style="border: 5px solid #000000; width:100%">
      <tr><td>
        <table style="border: 2px solid #000000;">
          ...
          <tr>
            <td align="left" colspan="2" style="padding-top:15px">This activity was designated for a maximum of <?php print $certificate['amapracat1'].$pratext?>.         
            </td>
          </tr>
          <tr>
            <td align="left" colspan="2" style="padding-top:15px"><span style='font-weight: bold;'>Clinician participated in <?php print $certificate['creditearned']?> hour<?php print $plural?> of this activity.</span>            
            </td>
          </tr>
          <tr>
