...
<table width="600px">
          ...
          <tr>
            <td align="left" colspan="2" style="padding-top:20px"><span style='font-size:12.0pt;'>This activity was designated for <?php print $certificate['amapracat1'].$pratext ?>.</span></td>
          </tr>  
          <tr>
