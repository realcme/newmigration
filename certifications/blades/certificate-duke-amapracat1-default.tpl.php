  ...
  <tr>
   <td>
     <table width="100%" style="border: 7px solid #1F497D;">   
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:10px;font-size:18pt;font-weight:bold;font-family: Times New Roman;font-style:italic;">Statement of Attendance</td>
          </tr>
          <tr>
            <td align="center" colspan="2" style="padding-top:20px;">The Duke University School of Medicine certifies that</td>
          </tr>
          <tr>
            <td align="center" colspan="2" style="padding-top:10px;font-weight:bold;font-size:14pt;"><?php print $certificate['firstname'] ?> <?php print $certificate['lastname'] ?></td>
          </tr>
          <tr>
