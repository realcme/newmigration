  ...
  <div style="font-size:11.0pt;font-family: Times, serif;width: 600px;margin: auto; text-align: center;">
    <div style="width: 100%;">
      <div class="content" style="width:100%">
        <h3>AMA PRA Category 1 Credit(s)&trade; Certificate</h3>
	...
	<p>and has been awarded <?php print $certificate['creditearned'];?> <i>AMA PRA Category 1 Credit(s).</i></p>
	...
	<p>Vindico Medical Education designates this enduring material activity for a maximum of <?php print $certificate['amapracat1'];?> <i>AMA PRA Category 1 Credit(s)&trade;</i>. Physicians should claim only the credit commensurate with the extent of their participation in the activity.</p>
