    ...
    <table style="border: 3px solid #D6AD00;width:600px">
      <tr><td>
        <table style="border: 1px solid #D6AD00;width:100%">
          ...
          <tr>
            <td align="center" colspan="2" style="padding-top:10px;padding-bottom:20px">This activity was designated for  <?php print $certificate['amapracat1'].$pratext ?>
            <br/>This participant attended <?php print $certificate['creditearned'] ?> hour(s).</td>
          </tr>                
          <tr>
