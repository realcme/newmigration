...
<table width="600px" style="border: none">
    ...
    <tr>
      <td colspan="2" align="center" style="padding-top:10px;font-weight: bold;font-size: 32px;color:#000010">Certificate of Credit</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2" align="center" style="padding-top:10px;font-weight:bold; font-size: 18px;">
    ...
    <tr>
      <td colspan="2" align="center" style="padding-top:20px">
          ...
          <?php print $certificate['firstname'] ?> <?php print $certificate['lastname'] ?>, <?php print $certificate['profession'] ?>
          has participated in the enduring material outlined above and is awarded
