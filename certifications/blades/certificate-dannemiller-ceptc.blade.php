...
<table width="600px" style="border: 1px solid black;">
          ...
          <tr>
            ...
            Dannemiller certifies that the above individual has participated in the enduring activity titled  
            "<?php print $certificate['course_title'] ?>" on <?php print $certificate['dateearned'] ?> 
            and is awarded <?php print $certificate['creditearned']?> category 1 CEPTCs. CEPTC Provider Number: 161-01
						</td>
          </tr>     
          <tr>
            <td align="left" colspan="2" style="padding-top:15px;padding-left: 10px">
            Dannemiller is approved as a provider of American Board for Transplant Certification continuing education: CEPTC Approved Provider Number: 161. 
            This continuing education activity is approved by the American Board for Transplant Certification for <?php print $certificate['ceptc']?> category 1 CEPTCs.
						</td>
          </tr>        
          <tr>
          ...
          <tr>
            <td align="left" colspan="2" style="padding-top:25px;padding-left: 10px">
              DO NOT SEND THIS CERTIFICATE TO THE AMERICAN BOARD OF TRANSPLANT COORDINATORS. KEEP IT FOR YOUR PERSONAL RECORDS.
            </td>
          </tr>         
          <tr>
