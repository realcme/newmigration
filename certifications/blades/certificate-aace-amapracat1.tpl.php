    ...
    <body style="font-size: 10pt; font-family: Arial, Helvetica, sans-serif;">
        ...
        <div style="border:2px solid black; padding:2px; width:620px; display: block; margin: 0 auto;">
            <div style="border:4px solid black; padding: 25px; width:562px; display: block;">
                ...
                <img src="<?php print $img_url?>aace-header.png" style="width:435px; height: auto; display: inline; float: left; margin-left: 25px;"></img>
                ...
                <table style="margin-top: 25px;">
                  ...
                  <tr>
                    <td style="font-weight: bold;">Awarded:</td>               <td><i><?php print $certificate['creditearned']; ?> AMA PRA Category 1 Credit(s)&trade;</i></td>
                  </tr>
                </table>
