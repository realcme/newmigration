...
$begin_date = strftime("%m/%d/%Y", strtotime($certificate['begin_date']));
?>
  ...
  <table style="border: 5px solid #FDB141; width:620px;padding: 0px;background-color:#FFFFFF">
    <tr><td>
      <table style="border: 2px solid #FDB141; width:100%;border-top: none;">
        ...
        <tr>
          <td align="center" colspan="2" style="padding-top:25px; font-size: 11pt;">On the internet at http://www.realcme.com</td>
        </tr>
        <tr>
          <td align="center" colspan="2" style="padding-top:25px;font-size: 11pt;"><?php print $issue_date ?></td>
        </tr>   
        <!--<tr>
        ...
        <tr>
          ...
          <div style="width: 95%; font-size:9pt; text-align:justify;"><strong>AAFP:</strong> This Enduring Material activity, <?php print $certificate['course_title']?>, has been reviewed and is acceptable for up to 
          <?php print $certificate['aafp']?> Prescribed credit(s) by the American Academy of Family Physicians (AAFP).  Term of approval begins <?php print $begin_date?>. Term of approval is for one year from this date. Physicians should claim only the credit commensurate with the extent of their participation in the activity.
          </div></td>
        </tr>          
        <tr>
