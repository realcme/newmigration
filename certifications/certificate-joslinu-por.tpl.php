...
$date_earned = strftime("%m/%d/%Y", strtotime($certificate['dateearned']));
        ...
        <tr>
            <td>
                <table width="618px" style="border: 4px solid #404040;">
                    ...
                    <tr>
                        <td align="center" colspan="2" style="padding-top:15px">completou a atividade entitulada</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center" colspan="2" valign="bottom" style="padding-left:20px;padding-bottom:20px;margin-bottom:0px;font-size:10pt">
                            ...
                            <div style="position:relative;bottom:0px">
                                ...
                                <b><span><small>Diretor,  Educação Profissional Internacional</small></span></b><br />
